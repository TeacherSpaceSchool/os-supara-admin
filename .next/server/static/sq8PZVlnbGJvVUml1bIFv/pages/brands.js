...
// CONCATENATED MODULE: ./components/brand/CardBrand.js
...
const CardBrand = external_react_default.a.memo(props => {
...
/* harmony default export */ var brand_CardBrand = (Object(external_react_redux_["connect"])(mapStateToProps)(CardBrand));
...
// CONCATENATED MODULE: ./components/brand/CardBrandPlaceholder.js
var CardBrandPlaceholder_jsx = external_react_default.a.createElement;
...
const CardOrganizationPlaceholder = external_react_default.a.memo(props => {
  ...
  return CardBrandPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: 80
    }
  }, CardBrandPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardBrandPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var CardBrandPlaceholder = (Object(external_react_redux_["connect"])(CardBrandPlaceholder_mapStateToProps)(CardOrganizationPlaceholder));
...
const Organization = external_react_default.a.memo(props => {
  ...
  return brands_jsx(App["a" /* default */], {
    filters: data.filterOrganization,
    sorts: data.sortOrganization,
    pageName: "\u0411\u0440\u0435\u043D\u0434\u044B"
  }, brands_jsx(head_default.a, null, brands_jsx("title", null, "\u0411\u0440\u0435\u043D\u0434\u044B"), brands_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/brands`
  }), brands_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/brands`
  })), brands_jsx("div", {
    className: classes.page
  }, list ? list.map(element => brands_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: brands_jsx(CardBrandPlaceholder, {
      height: height
    })
  }, brands_jsx(brand_CardBrand, {
    key: element._id,
    element: element
  }))) : null));
});
...
function brands_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var brands = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(brands_mapStateToProps, mapDispatchToProps)(Organization));
...
module.exports = __webpack_require__("7zp8");
