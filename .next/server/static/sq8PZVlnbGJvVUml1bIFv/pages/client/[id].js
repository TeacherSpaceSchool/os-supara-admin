...
module.exports = __webpack_require__("HBAf");
...
// EXTERNAL MODULE: ./src/gql/client.js
var client = __webpack_require__("i3N8");

// EXTERNAL MODULE: external "@material-ui/core/styles"
var styles_ = __webpack_require__("9Pu4");

// CONCATENATED MODULE: ./src/styleMUI/client/client.js

/* harmony default export */ var client_client = (Object(styles_["makeStyles"])({
  page: {
    margin: '20px'
  },
  row: {
...
// CONCATENATED MODULE: ./pages/client/[id].js
...
const Client = external_react_default.a.memo(props => {
  const {
    profile
  } = props.user;
  const classes = client_client();
  const {
    data
  } = props;
  const {
  ...
  let {
    0: status,
    1: setStatus
  } = Object(external_react_["useState"])(data.client ? data.client.user.status : '');
  let {
    0: name,
    1: setName
  } = Object(external_react_["useState"])(data.client ? data.client.name : '');
  let {
    0: email,
    1: setEmail
  } = Object(external_react_["useState"])(data.client ? data.client.email : '');
  let {
    0: phone,
    1: setPhone
  } = Object(external_react_["useState"])(data.client ? data.client.phone : []);
  ...
  let {
    0: login,
    1: setLogin
  } = Object(external_react_["useState"])(data.client ? data.client.user.login : ''); //привести к геолокации

  if (!is_array_default()(data.client.address[0])) data.client.address.map(addres => [addres]);
  let {
    0: address,
    1: setAddress
  } = Object(external_react_["useState"])(data.client ? data.client.address : []);
  let {
    0: birthday,
    1: setBirthday
  } = Object(external_react_["useState"])(data.client ? Object(lib["h" /* pdDatePicker */])(new Date(data.client.birthday)) : null);
  let {
    0: city,
    1: setCity
  } = Object(external_react_["useState"])(data.client ? data.client.city : '');
  let {
    0: type,
    1: setType
  } = Object(external_react_["useState"])(data.client ? data.client.type : '');
  ...
  let {
    0: info,
    1: setInfo
  } = Object(external_react_["useState"])(data.client ? data.client.info : '');
  let {
    0: preview,
    1: setPreview
  } = Object(external_react_["useState"])(data.client ? data.client.image : '');
  let {
    0: image,
    1: setImage
  ...
  let patentRef = Object(external_react_["useRef"])(null);
  let {
    0: passport,
    1: setPassport
  } = Object(external_react_["useState"])(undefined);
  ...
  let passportRef = Object(external_react_["useRef"])(null);
  let {
    0: certificate,
    1: setCertificate
  } = Object(external_react_["useState"])(undefined);
  ...
  let certificateRef = Object(external_react_["useRef"])(null);
  const {
    setMiniDialog,
    showMiniDialog
  ...
  let {
    0: hide,
    1: setHide
  } = Object(external_react_["useState"])('password');
  ...
  return __jsx(App["a" /* default */], {
  ...
  }, __jsx(head_default.a, null, __jsx("title", null, data.client ? data.client.name : 'Ничего не найдено'), __jsx("meta", {
    name: "description",
    content: info
  }), __jsx("meta", {
    property: "og:title",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/client/${router.query.id}`
  }), __jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/client/${router.query.id}`
  ...
  }, data.client ? profile.role === 'admin' || profile._id === data.client.user._id ? __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    ...
    src: preview,
    alt: 'Добавить'
  })), type === 'торговая точка' ? __jsx(external_react_default.a.Fragment, null, __jsx("div", {
  ...
  }, patent || patentUrl && patentUrl.length > 0 ? 'Изменить' : 'Добавить'))) : null), __jsx("div", null, __jsx(TextField_default.a, {
    label: "\u0418\u043C\u044F",
    value: name,
    ...
    endAdornment: __jsx(InputAdornment_default.a, {
      ...
      onClick: handleHide
    }, hide ? __jsx(VisibilityOff_default.a, null) : __jsx(Visibility_default.a, null)))
  }), __jsx(FormControl_default.a, {
    className: classes.input
  }, __jsx(InputLabel_default.a, null, "\u0422\u0438\u043F \u043A\u043B\u0438\u0435\u043D\u0442\u0430"), __jsx(Select_default.a, {
    value: type,
    onChange: handleType
  }, types.map(element => __jsx(MenuItem_default.a, {
    key: element,
    value: element
  }, element)))), __jsx(TextField_default.a, {
    className: classes.input,
    label: "\u0414\u0435\u043D\u044C \u0440\u043E\u0436\u0434\u0435\u043D\u0438\u0435",
    type: "date",
    InputLabelProps: {
    ...
    className: classes.input
  }, __jsx(InputLabel_default.a, null, "\u0422\u0435\u043B\u0435\u0444\u043E\u043D. \u0424\u043E\u0440\u043C\u0430\u0442: +996555780861"), __jsx(Input_default.a, {
  ...
  })))) : null, __jsx(Button_default.a, {
    onClick: async () => {
      addPhone();
    },
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u0435\u043B\u0435\u0444\u043E\u043D"), __jsx("br", null), __jsx("br", null), address ? address.map((element, idx) => __jsx("div", {
    key: idx
  }, __jsx(FormControl_default.a, {
    className: classes.input
  }, __jsx(InputLabel_default.a, null, "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043C\u0430\u0433\u0430\u0437\u0438\u043D\u0430"), __jsx(Input_default.a, {
    ...
    className: classes.input
  }, __jsx(InputLabel_default.a, null, "\u0410\u0434\u0440\u0435\u0441 \u043C\u0430\u0433\u0430\u0437\u0438\u043D\u0430"), __jsx(Input_default.a, {
    placeholder: "\u0410\u0434\u0440\u0435\u0441",
    value: element[0],
    className: classes.input,
    onChange: event => {
  ...
  }, element[1] ? 'Изменить геолокацию' : 'Задайте геолокацию'))) : __jsx("br", null), __jsx(Button_default.a, {
    onClick: async () => {
      addAddress();
    },
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0430\u0434\u0440\u0435\u0441"), __jsx("br", null), __jsx("br", null), __jsx(TextField_default.a, {
    label: "email",
    value: email,
    className: classes.input,
    onChange: event => {
    ...
    onClick: async () => {
      ...
      const action = async () => {
        await Object(client["d" /* setClient */])(editElement);
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), profile.role === 'admin' ? __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(client["c" /* onoffClient */])([data.client._id]);
    ...
    size: "small",
    color: "primary"
  }, status === 'active' ? 'Отключить' : 'Включить') : __jsx(Button_default.a, {
    onClick: () => {
      const action = async () => {
        logout(true);
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0412\u044B\u0439\u0442\u0438")))) : __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    className: classes.column
  }, __jsx("img", {
    className: classes.media,
    src: preview,
  ...
  }, "\u0421\u043A\u0430\u0447\u0430\u0442\u044C \u043F\u0430\u0442\u0435\u043D\u0442")) : null), __jsx("div", null, __jsx("div", {
    ...
    className: classes.column
  }, address ? address.map((element, idx) => __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    ...
    className: classes.column
  }, phone ? phone.map((element, idx) => __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    className: classes.value,
    key: idx
...
Client.getInitialProps = async function (ctx) {
  return {
    data: await Object(client["a" /* getClient */])({
      _id: ctx.query.id
    })
  };
};
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Client));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getClients; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return onoffClient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return setClient; });
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("YvTO");
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(apollo_boost__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _singleton_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("gIpB");
/* harmony import */ var _singleton_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("gs4i");
...
const onoffClient = async ids => {
  try {
    ...
    return await getClients(new _singleton_store__WEBPACK_IMPORTED_MODULE_2__[/* SingletonStore */ "a"]().getStore().getState().app);
  } catch (err) {
    console.error(err);
  }
};
const setClient = async element => {
  try {
    ...
    let list = await getClients(new _singleton_store__WEBPACK_IMPORTED_MODULE_2__[/* SingletonStore */ "a"]().getStore().getState().app);
    return list;
  } catch (err) {
    console.error(err);
  }
