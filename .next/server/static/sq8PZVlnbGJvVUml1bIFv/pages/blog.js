...
// CONCATENATED MODULE: ./src/styleMUI/blog/blogList.js

/* harmony default export */ var blogList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
var store = __webpack_require__("gs4i");

// CONCATENATED MODULE: ./src/gql/blog.js
...
const deleteBlog = async ids => {
  try {
    ...
    return await getBlogs(new store["a" /* SingletonStore */]().getStore().getState().app);
  } catch (err) {
    console.error(err);
  }
};
const addBlog = async element => {
  try {
    ...
    let list = await getBlogs(new store["a" /* SingletonStore */]().getStore().getState().app);
    return list;
  } catch (err) {
    console.error(err);
  }
...
// CONCATENATED MODULE: ./src/styleMUI/blog/cardBlog.js

/* harmony default export */ var cardBlog = (Object(styles_["makeStyles"])({
  cardM: {
...
// CONCATENATED MODULE: ./components/blog/CardBlog.js
...
const CardBlog = external_react_default.a.memo(props => {
  const classes = cardBlog();
  const {
    element,
    setList
  } = props;
  ...
  let {
    0: text,
    1: setText
  } = Object(external_react_["useState"])(element ? element.text : '');

  let handleText = event => {
    setText(event.target.value);
  };

  let date = Object(lib["g" /* pdDDMMYYYY */])(element ? new Date(element.createdAt) : new Date());
  const {
    setMiniDialog,
    showMiniDialog
  ...
  }, profile.role === 'admin' ? __jsx(external_react_default.a.Fragment, null, __jsx(CardHeader_default.a, {
    subheader: date
  ...
  })) : element !== undefined ? __jsx(external_react_default.a.Fragment, null, __jsx(CardActionArea_default.a, null, __jsx("img", {
    className: isMobileApp ? classes.mediaM : classes.mediaD,
    src: element.image,
    alt: element.title
  }), __jsx("div", {
  ...
  }, element.text) : null, __jsx(Button_default.a, {
    onClick: async () => {
      setAll(!all);
    },
    size: "small",
...
/* harmony default export */ var blog_CardBlog = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardBlog));
...
// CONCATENATED MODULE: ./components/blog/CardBlogPlaceholder.js
var CardBlogPlaceholder_jsx = external_react_default.a.createElement;
...
const CardBlogPlaceholder = external_react_default.a.memo(props => {
  ...
  return CardBlogPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, CardBlogPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardBlogPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var blog_CardBlogPlaceholder = (Object(external_react_redux_["connect"])(CardBlogPlaceholder_mapStateToProps)(CardBlogPlaceholder));
...
const Blog = external_react_default.a.memo(props => {
  ...
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.blogs);
  const {
    search,
    filter,
    sort
  ...
  return blog_jsx(App["a" /* default */], {
    filters: data.filterBlog,
    sorts: data.sortBlog,
    pageName: "\u0411\u043B\u043E\u0433"
  }, blog_jsx(head_default.a, null, blog_jsx("title", null, "\u0411\u043B\u043E\u0433"), blog_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/blog`
  }), blog_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/blog`
  })), blog_jsx("div", {
    className: classes.page
  }, profile.role === 'admin' ? blog_jsx(blog_CardBlog, {
    setList: setList
  }) : null, list ? list.map(element => blog_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: blog_jsx(blog_CardBlogPlaceholder, {
      height: height
    })
  }, blog_jsx(blog_CardBlog, {
    key: element._id,
    setList: setList,
    element: element
  }))) : null));
...
function blog_mapStateToProps(state) {
  return {
    app: state.app,
    user: state.user
  };
...
/* harmony default export */ var blog = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(blog_mapStateToProps)(Blog));
