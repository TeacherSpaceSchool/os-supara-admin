...
module.exports = __webpack_require__("fXxH");
...
// CONCATENATED MODULE: ./components/bonusclient/CardBonusClient.js
var __jsx = external_react_default.a.createElement;
...
const CardBonus = external_react_default.a.memo(props => {
  ...
  }), __jsx("div", null, !['организация', 'менеджер'].includes(profile.role) ? __jsx(link_default.a, {
    href: "/organization/[id]",
  ...
  }, "\u041A\u043B\u0438\u0435\u043D\u0442:\xA0"), __jsx(link_default.a, {
    href: "/client/[id]",
...
/* harmony default export */ var CardBonusClient = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardBonus));
...
// CONCATENATED MODULE: ./components/bonusclient/CardBonusClientPlaceholder.js
var CardBonusClientPlaceholder_jsx = external_react_default.a.createElement;
...
const CardBlogPlaceholder = external_react_default.a.memo(props => {
  ...
  return CardBonusClientPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, CardBonusClientPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardBonusClientPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var CardBonusClientPlaceholder = (Object(external_react_redux_["connect"])(CardBonusClientPlaceholder_mapStateToProps)(CardBlogPlaceholder));
// CONCATENATED MODULE: ./pages/bonusclient.js
var bonusclient_jsx = external_react_default.a.createElement;
...
const BonusClient = external_react_default.a.memo(props => {
  ...
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.bonusesClient);
  const {
    search,
    sort
  } = props.app;
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(bonusclient["a" /* getBonusesClient */])({
        search: search,
        sort: sort
      })).bonusesClient);
    })();
  }, [sort, search]);
  return bonusclient_jsx(App["a" /* default */], {
    sorts: data.sortBonusClient,
    pageName: ['admin', 'организация', 'менеджер'].includes(profile.role) ? 'Бонусы клиентов' : 'Мои бонусы'
  }, bonusclient_jsx(head_default.a, null, bonusclient_jsx("title", null, ['admin', 'организация', 'менеджер'].includes(profile.role) ? 'Бонусы клиентов' : 'Мои бонусы'), bonusclient_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/bonusclient`
  }), bonusclient_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/bonusclient`
  })), bonusclient_jsx("div", {
    className: classes.page
  }, list ? list.map(element => bonusclient_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: bonusclient_jsx(CardBonusClientPlaceholder, {
      height: height
    })
  }, bonusclient_jsx(CardBonusClient, {
    key: element._id,
    element: element
  }))) : null));
});

BonusClient.getInitialProps = async function () {
  return {
    data: await Object(bonusclient["a" /* getBonusesClient */])({
      search: '',
      sort: '-createdAt'
    })
  };
...
function bonusclient_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
function bonusclient_mapDispatchToProps(dispatch) {
  return {
    userActions: Object(external_redux_["bindActionCreators"])(user, dispatch)
  };
}

/* harmony default export */ var pages_bonusclient = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(bonusclient_mapStateToProps, bonusclient_mapDispatchToProps)(BonusClient));
