...
module.exports = __webpack_require__("zjJo");
...
// CONCATENATED MODULE: ./src/styleMUI/employment/employment.js

/* harmony default export */ var employment_employment = (Object(styles_["makeStyles"])({
  page: {
    margin: '20px'
  },
  row: {
...
// CONCATENATED MODULE: ./pages/employment/[id].js
...
const Client = external_react_default.a.memo(props => {
  ...
  const classes = employment_employment();
  const {
    data
  } = props;
  const {
  ...
  let {
    0: status,
    1: setStatus
  } = Object(external_react_["useState"])(data.employment !== null ? data.employment.user.status : '');
  let {
    0: name,
    1: setName
  } = Object(external_react_["useState"])(data.employment !== null ? data.employment.name : '');
  let {
    0: email,
    1: setEmail
  } = Object(external_react_["useState"])(data.employment !== null ? data.employment.email : '');
  let {
    0: phone,
    1: setPhone
  } = Object(external_react_["useState"])(data.employment ? data.employment.phone : []);
  ...
  let {
    0: login,
    1: setLogin
  } = Object(external_react_["useState"])(data.employment ? data.employment.user.login : '');
  let {
    0: organization,
    1: setOrganization
  } = Object(external_react_["useState"])(data.employment !== null ? data.employment.organization : {});
  ...
  let {
    0: role,
    1: setRole
  } = Object(external_react_["useState"])(data.employment !== null ? data.employment.user.role : '');
  ...
  return __jsx(App["a" /* default */], {
  ...
  }, __jsx(head_default.a, null, __jsx("title", null, data.employment !== null ? router.query.id === 'new' ? 'Добавить' : data.employment.name : 'Ничего не найдено'), __jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/employment/${router.query.id}`
  }), __jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/employment/${router.query.id}`
  ...
  }, data.employment !== null ? profile.role === 'admin' || profile.role === 'организация' || profile._id === data.employment.user._id ? __jsx(external_react_default.a.Fragment, null, __jsx("div", null, __jsx(TextField_default.a, {
    label: "\u041B\u043E\u0433\u0438\u043D",
    value: login,
    ...
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u0435\u043B\u0435\u0444\u043E\u043D"), __jsx("br", null), __jsx("br", null), __jsx(TextField_default.a, {
    label: "email",
    value: email,
    className: classes.input,
    onChange: event => {
  ...
  }), router.query.id === 'new' && profile.role === 'admin' ? __jsx(FormControl_default.a, {
    className: classes.input
    ...
    value: element._id,
    ola: element.name
  }, element.name)))) : router.query.id !== 'new' ? __jsx(TextField_default.a, {
    label: "\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u044F",
  ...
  }) : null, __jsx(FormControl_default.a, {
    className: classes.input
  }, __jsx(InputLabel_default.a, null, "\u0420\u043E\u043B\u044C"), __jsx(Select_default.a, {
    value: role,
    onChange: handleRole,
    inputProps: {
      'aria-label': 'description',
    ...
    onClick: async () => {
      if (name.length > 0 && email.length > 0 && password.length > 0 && phone.length > 0 && role.length > 0 && organization._id !== undefined) {
        const action = async () => {
          await Object(employment["a" /* addEmployment */])({
            name: name,
            email: email,
            phone: phone,
            login: login,
          ...
          router_default.a.push('/employments');
        };
    ...
    onClick: async () => {
      ...
      const action = async () => {
        await Object(employment["g" /* setEmployments */])(editElement);
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), profile._id !== data.employment.user._id && ['admin', 'организация'].includes(profile.role) ? __jsx(external_react_default.a.Fragment, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(employment["f" /* onoffEmployment */])([data.employment._id]);
    ...
    onClick: async () => {
      const action = async () => {
        await Object(employment["b" /* deleteEmployment */])([data.employment._id]);
        router_default.a.push('/employments');
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C")) : null, profile._id === data.employment.user._id ? __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        logout(true);
      };
...
Client.getInitialProps = async function (ctx) {
  ...
  return {
    data: Object(objectSpread["a" /* default */])({}, ctx.query.id !== 'new' ? await Object(employment["d" /* getEmployment */])({
      _id: ctx.query.id
    }) : {
      employment: {
        name: '',
