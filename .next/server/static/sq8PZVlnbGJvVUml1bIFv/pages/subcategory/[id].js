...
module.exports = __webpack_require__("hBRP");
...
// EXTERNAL MODULE: ./src/gql/category.js
var gql_category = __webpack_require__("syjg");

// EXTERNAL MODULE: external "@material-ui/core/styles"
var styles_ = __webpack_require__("9Pu4");

// CONCATENATED MODULE: ./src/styleMUI/subcategory/subcategoryList.js

/* harmony default export */ var subcategoryList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./src/styleMUI/subcategory/cardSubcategory.js

/* harmony default export */ var cardSubcategory = (Object(styles_["makeStyles"])({
  cardM: {
...
// CONCATENATED MODULE: ./components/subcategory/SubCardCategory.js
var __jsx = external_react_default.a.createElement;
...
const CardCategory = external_react_default.a.memo(props => {
  const classes = cardSubcategory();
  const {
    element,
    setList,
    category,
  ...
  let {
    0: name,
    1: setName
  } = Object(external_react_["useState"])(element ? element.name : '');
  ...
  let {
    0: selectCategory,
    1: setSelectCategory
  } = Object(external_react_["useState"])(element ? element.category : {});
  ...
  return __jsx(Card_default.a, {
  ...
  }, profile.role === 'admin' && (!element || element._id !== 'all') ? __jsx(external_react_default.a.Fragment, null, __jsx(CardActionArea_default.a, null, __jsx(CardContent_default.a, null, __jsx(TextField_default.a, {
    label: "\u0418\u043C\u044F",
    value: name,
  ...
  }), __jsx("br", null), __jsx("br", null), __jsx(FormControl_default.a, {
    className: classes.input
  }, __jsx(InputLabel_default.a, null, "\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F"), __jsx(Select_default.a, {
    value: selectCategory._id,
    onChange: handleSelectCategory
  }, categorys ? categorys.map(element => __jsx(MenuItem_default.a, {
    key: element._id,
    value: element._id,
    ola: element.name
  }, element.name)) : null)))), __jsx(CardActions_default.a, null, element !== undefined ? __jsx(external_react_default.a.Fragment, null, __jsx(Button_default.a, {
    onClick: async () => {
      let editElement = {
        _id: element._id
      };
      ...
      const action = async () => {
        setList((await Object(subcategory["d" /* setSubCategory */])(editElement, category)).subCategorys);
      };
    ...
    onClick: async () => {
      const action = async () => {
        setList((await Object(subcategory["c" /* onoffSubCategory */])([element._id], category)).subCategorys);
      };
    ...
    size: "small",
    color: "primary"
  }, element.status === 'active' ? 'Отключить' : 'Включить'), __jsx(link_default.a, {
    href: "/items/[id]",
    as: `/items/${element._id}`
  }, __jsx(Button_default.a, {
    size: "small",
    color: "primary"
  }, "\u041F\u0435\u0440\u0435\u0439\u0442\u0438"))) : __jsx(Button_default.a, {
    onClick: async () => {
      if (name.length > 0 && selectCategory._id) {
        ...
        const action = async () => {
          let subCategorys = (await Object(subcategory["a" /* addSubCategory */])({
            name: name
    ...
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C"))) : element !== undefined ? __jsx(CardActionArea_default.a, null, __jsx(link_default.a, {
    href: "/items/[id]",
    as: `/items/${element._id}`
  }, __jsx("div", {
...
/* harmony default export */ var SubCardCategory = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardCategory));
// EXTERNAL MODULE: external "next/router"
var router_ = __webpack_require__("4Q3z");
...
// CONCATENATED MODULE: ./components/subcategory/SubCardCategoryPlaceholder.js
var SubCardCategoryPlaceholder_jsx = external_react_default.a.createElement;




const SubCardCategoryPlaceholder = external_react_default.a.memo(props => {
  const classes = cardSubcategory();
  const {
    height
  } = props;
  ...
  return SubCardCategoryPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, SubCardCategoryPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function SubCardCategoryPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var subcategory_SubCardCategoryPlaceholder = (Object(external_react_redux_["connect"])(SubCardCategoryPlaceholder_mapStateToProps)(SubCardCategoryPlaceholder));
// CONCATENATED MODULE: ./pages/subcategory/[id].js
...
const Subcategory = external_react_default.a.memo(props => {
  const classes = subcategoryList();
  const {
    data
  } = props;
  const router = Object(router_["useRouter"])();
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.subCategorys);
  let {
    0: categorys,
    1: setCategorys
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      if (profile.role === 'admin') setCategorys((await Object(gql_category["c" /* getCategorys */])({
        search: '',
        sort: 'name',
        filter: ''
      })).categorys);
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(subcategory["b" /* getSubCategorys */])({
  ...
  return _id_jsx(App["a" /* default */], {
  ...
  }, _id_jsx(head_default.a, null, _id_jsx("title", null, router.query.id === 'all' ? 'Все' : data.category ? data.category.name : 'Ничего не найдено'), _id_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/subcategory/${router.query.id}`
  }), _id_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/subcategory/${router.query.id}`
  })), _id_jsx("div", {
    className: classes.page
  }, profile.role === 'admin' ? _id_jsx(SubCardCategory, {
    categorys: categorys,
    category: router.query.id,
    setList: setList
  }) : null, _id_jsx(SubCardCategory, {
    element: {
      _id: 'all',
      name: 'Все товары'
    }
  }), data.subCategorys.length > 0 || router.query.id === 'all' ? list ? list.map(element => _id_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: _id_jsx(subcategory_SubCardCategoryPlaceholder, {
      height: height
    })
  }, _id_jsx(SubCardCategory, {
    category: router.query.id,
    categorys: categorys,
    setList: setList,
    element: element
...
Subcategory.getInitialProps = async function (ctx) {
  return {
    data: await Object(subcategory["b" /* getSubCategorys */])({
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(_id_mapStateToProps)(Subcategory));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getCategorys; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return deleteCategory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return onoffCategory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addCategory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return setCategory; });
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("YvTO");
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(apollo_boost__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _singleton_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("gIpB");
/* harmony import */ var _singleton_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("gs4i");
...
const deleteCategory = async ids => {
  try {
    ...
    return await getCategorys(new _singleton_store__WEBPACK_IMPORTED_MODULE_2__[/* SingletonStore */ "a"]().getStore().getState().app);
  } catch (err) {
    console.error(err);
  }
};
