...
var organization = __webpack_require__("mHgh");

// EXTERNAL MODULE: external "@material-ui/core/styles"
var styles_ = __webpack_require__("9Pu4");

// CONCATENATED MODULE: ./src/styleMUI/organization/organization.js

/* harmony default export */ var organization_organization = (Object(styles_["makeStyles"])({
  page: {
    margin: '20px'
  },
  row: {
...
var employment = __webpack_require__("175S");
...
// CONCATENATED MODULE: ./pages/organization/[id].js
...
const Organization = external_react_default.a.memo(props => {
  const classes = organization_organization();
  const {
    data
  } = props;
  const {
  ...
  let {
    0: statusO,
    1: setStatusO
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.status : '');
  let {
    0: name,
    1: setName
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.name : '');
  let {
    0: minimumOrder,
    1: setMinimumOrder
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.minimumOrder : 0);
  let {
    0: address,
    1: setAddress
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.address : []);
  let {
    0: newAddress,
    1: setNewAddress
  ...
  let {
    0: email,
    1: setEmail
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.email : []);
  let {
    0: newEmail,
    1: setNewEmail
  } = Object(external_react_["useState"])('');
  ...
  let {
    0: phone,
    1: setPhone
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.phone : []);
  let {
    0: newPhone,
    1: setNewPhone
  } = Object(external_react_["useState"])('');
  ...
  let {
    0: info,
    1: setInfo
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.info : '');
  let {
    0: preview,
    1: setPreview
  } = Object(external_react_["useState"])(data.organization !== null ? data.organization.image : '');
  let {
    0: image,
    1: setImage
  ...
  return __jsx(App["a" /* default */], {
  ...
  }, __jsx(head_default.a, null, __jsx("title", null, data.organization !== null ? router.query.id === 'new' ? 'Добавить' : data.organization.name : 'Ничего не найдено'), __jsx("meta", {
    name: "description",
    content: info
  }), __jsx("meta", {
    property: "og:title",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/organization/${router.query.id}`
  }), __jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/organization/${router.query.id}`
  })), __jsx(Card_default.a, {
    className: classes.page
  }, __jsx(CardActions_default.a, {
    className: isMobileApp ? classes.column : classes.row,
    style: isMobileApp ? {} : {
      justifyContent: 'start',
      alignItems: 'flex-start'
    }
  }, data.organization !== null ? profile.role === 'admin' || profile.role === 'организация' && data.employment.organization._id === data.organization._id ? __jsx(external_react_default.a.Fragment, null, __jsx("label", {
    ...
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(InputLabel_default.a, null, "\u041C\u0438\u043D\u0438\u043C\u0430\u043B\u044C\u043D\u044B\u0439 \u0437\u0430\u043A\u0430\u0437"), __jsx(Input_default.a, {
    value: minimumOrder,
    onChange: event => {
      setMinimumOrder(Object(lib["b" /* checkInt */])(event.target.value));
    },
    inputProps: {
      'aria-label': 'description'
    }
  })), address.map((element, idx) => __jsx(FormControl_default.a, {
    key: idx,
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(InputLabel_default.a, null, "\u0410\u0434\u0440\u0435\u0441", idx + 1), __jsx(Input_default.a, {
    placeholder: "\u0410\u0434\u0440\u0435\u0441",
    value: element,
    onChange: event => {
    ...
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0430\u0434\u0440\u0435\u0441"), __jsx("br", null), __jsx("br", null), email.map((element, idx) => __jsx(FormControl_default.a, {
    key: idx,
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(InputLabel_default.a, null, "Email", idx + 1), __jsx(Input_default.a, {
    value: element,
    onChange: event => {
      editEmail(event, idx);
    },
    ...
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C email"), __jsx("br", null), __jsx("br", null), phone.map((element, idx) => __jsx(FormControl_default.a, {
    key: idx,
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(InputLabel_default.a, null, "\u0422\u0435\u043B\u0435\u0444\u043E\u043D", idx + 1), __jsx(Input_default.a, {
    value: element,
    onChange: event => {
      editPhone(event, idx);
    },
    ...
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0442\u0435\u043B\u0435\u0444\u043E\u043D. \u0424\u043E\u0440\u043C\u0430\u0442: +996555780861"), __jsx("br", null), __jsx("br", null), __jsx(TextField_default.a, {
    multiline: true,
    label: "\u0418\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F",
    value: info,
    className: isMobileApp ? classes.inputM : classes.inputD,
    ...
    onClick: async () => {
      if (image !== undefined && name.length > 0 && email.length > 0 && address.length > 0 && phone.length > 0 && info.length > 0) {
        const action = async () => {
          await Object(organization["a" /* addOrganization */])({
            image: image,
            name: name,
            address: address,
            email: email,
          ...
          router_default.a.push('/organizations');
        };
    ...
    onClick: async () => {
      ...
      const action = async () => {
        await Object(organization["f" /* setOrganization */])(editElement);
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), profile.role === 'admin' ? __jsx(external_react_default.a.Fragment, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(organization["e" /* onoffOrganization */])([data.organization._id]);
    ...
    size: "small",
    color: "primary"
  }, statusO === 'active' ? 'Отключить' : 'Включить'), __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(organization["b" /* deleteOrganization */])([data.organization._id]);
        router_default.a.push('/organizations');
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C")) : null)))) : router.query.id === 'new' ? 'Ничего не найдено' : __jsx(external_react_default.a.Fragment, null, __jsx("img", {
    className: classes.media1,
    src: preview,
    alt: name
    ...
    className: classes.value
  }, minimumOrder, "\xA0\u0441\u043E\u043C")) : null, __jsx("br", null), __jsx("div", {
...
Organization.getInitialProps = async function (ctx) {
  return {
    data: Object(objectSpread["a" /* default */])({}, ctx.store.getState().user.authenticated && ['организация', 'менеджер'].includes(ctx.store.getState().user.profile.role) ? await Object(employment["d" /* getEmployment */])({
      _id: ctx.store.getState().user.profile._id
    }) : {}, ctx.query.id !== 'new' ? await Object(organization["c" /* getOrganization */])({
      _id: ctx.query.id
    }) : {
      organization: {
        name: '',
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Organization));
