...
module.exports = __webpack_require__("sUnw");
...
// CONCATENATED MODULE: ./src/styleMUI/employment/employmentList.js

/* harmony default export */ var employmentList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./src/styleMUI/employment/cardEmployment.js

/* harmony default export */ var cardEmployment = (Object(styles_["makeStyles"])({
  cardM: {
...
// CONCATENATED MODULE: ./components/employment/CardEmployment.js
var __jsx = external_react_default.a.createElement;
...
const CardEmployment = external_react_default.a.memo(props => {
  const classes = cardEmployment();
  const {
    element,
    setList
  } = props;
  ...
  let {
    0: status,
    1: setStatus
  } = Object(external_react_["useState"])(element !== undefined ? element.user.status : '');
  return __jsx(Card_default.a, {
    className: isMobileApp ? classes.cardM : classes.cardD
  }, __jsx(CardActionArea_default.a, null, __jsx(link_default.a, {
    href: "/employment/[id]",
    as: `/employment/${element.user._id}`
  }, __jsx(CardContent_default.a, null, __jsx("div", {
    ...
    className: classes.nameField
  }, "\u0422\u0435\u043B\u0435\u0444\u043E\u043D:\xA0"), __jsx("div", null, element.phone.map((phone, idx) => __jsx("div", {
    key: idx,
    className: classes.value
  }, phone)))), __jsx("div", {
    className: classes.row
    ...
    className: classes.value
  }, element.user.role))))), (profile.role === 'admin' || profile.role === 'организация') && profile._id !== element.user._id ? __jsx(CardActions_default.a, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(employment["f" /* onoffEmployment */])([element._id]);
    ...
    onClick: async () => {
      const action = async () => {
        const list = (await Object(employment["b" /* deleteEmployment */])([element._id])).employments;
        setList(list);
      };
...
/* harmony default export */ var employment_CardEmployment = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardEmployment));
...
// CONCATENATED MODULE: ./components/employment/CardEmploymentPlaceholder.js
var CardEmploymentPlaceholder_jsx = external_react_default.a.createElement;




const CardEmploymentPlaceholder = external_react_default.a.memo(props => {
  const classes = cardEmployment();
  const {
    isMobileApp
  } = props.app;
  const height = 186;
  return CardEmploymentPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, CardEmploymentPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardEmploymentPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var employment_CardEmploymentPlaceholder = (Object(external_react_redux_["connect"])(CardEmploymentPlaceholder_mapStateToProps)(CardEmploymentPlaceholder));
// CONCATENATED MODULE: ./pages/employments.js
var employments_jsx = external_react_default.a.createElement;
...
const employments_height = 186;
const Employment = external_react_default.a.memo(props => {
  const {
    profile
  } = props.user;
  const classes = employmentList();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.employments);
  const {
    search,
    filter,
    sort
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(employment["e" /* getEmployments */])({
        search: search,
        sort: sort,
        filter: filter
      })).employments);
  ...
  return employments_jsx(App["a" /* default */], {
    filters: data.filterEmployment,
    sorts: data.sortEmployment,
    pageName: "\u0421\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A\u0438"
  }, employments_jsx(head_default.a, null, employments_jsx("title", null, "\u0421\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A\u0438"), employments_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/employments`
  }), employments_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/employments`
  })), employments_jsx("div", {
    className: classes.page
  }, list ? list.map(element => employments_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: employments_height,
    offset: [employments_height, 0],
    debounce: 100,
    placeholder: employments_jsx(employment_CardEmploymentPlaceholder, {
      height: employments_height
    })
  }, employments_jsx(employment_CardEmployment, {
    key: element._id,
    setList: setList,
    element: element
  }))) : null), ['admin', 'организация'].includes(profile.role) ? employments_jsx(link_default.a, {
    href: "/employment/[id]",
    as: `/employment/new`
  }, employments_jsx(Fab_default.a, {
    color: "primary",
    "aria-label": "add",
    className: classes.fab
  }, employments_jsx(Add_default.a, null))) : null);
});
...
Employment.getInitialProps = async function (ctx) {
  ...
  return {
    data: await Object(employment["e" /* getEmployments */])({
      search: '',
      sort: '-createdAt',
      filter: ''
    })
...
function employments_mapStateToProps(state) {
  return {
    app: state.app,
    user: state.user
  };
...
/* harmony default export */ var employments = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(employments_mapStateToProps)(Employment));
