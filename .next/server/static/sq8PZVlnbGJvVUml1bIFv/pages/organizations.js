...
module.exports = __webpack_require__("vOa+");
...
// EXTERNAL MODULE: ./src/styleMUI/organization/orgaizationsList.js
var orgaizationsList = __webpack_require__("kRIg");
...
// EXTERNAL MODULE: ./src/styleMUI/organization/cardOrganization.js
var cardOrganization = __webpack_require__("x267");
...
// CONCATENATED MODULE: ./components/organization/CardOrganization.js
var __jsx = external_react_default.a.createElement;
...
const CardOrganization = external_react_default.a.memo(props => {
  const classes = Object(cardOrganization["a" /* default */])();
  const {
    element,
    setList
  } = props;
  ...
  let {
    0: status,
    1: setStatus
  } = Object(external_react_["useState"])(element !== undefined ? element.status : '');
  return __jsx(Card_default.a, {
  ...
  }, element.name)))), profile.role === 'admin' ? __jsx(CardActions_default.a, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(organization["e" /* onoffOrganization */])([element._id]);
    ...
    onClick: async () => {
      const action = async () => {
        const list = (await Object(organization["b" /* deleteOrganization */])([element._id])).organizations;
        setList(list);
      };
...
/* harmony default export */ var organization_CardOrganization = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardOrganization));
...
// CONCATENATED MODULE: ./components/organization/CardOrganizationPlaceholder.js
var CardOrganizationPlaceholder_jsx = external_react_default.a.createElement;




const CardOrganizationPlaceholder = external_react_default.a.memo(props => {
  const classes = Object(cardOrganization["a" /* default */])();
  const {
    height
  } = props;
  ...
  return CardOrganizationPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, CardOrganizationPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardOrganizationPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var organization_CardOrganizationPlaceholder = (Object(external_react_redux_["connect"])(CardOrganizationPlaceholder_mapStateToProps)(CardOrganizationPlaceholder));
// CONCATENATED MODULE: ./pages/organizations.js
...
const Organization = external_react_default.a.memo(props => {
  const classes = Object(orgaizationsList["a" /* default */])();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.organizations);
  const {
    search,
    filter,
    sort
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(organization["d" /* getOrganizations */])({
        search: search,
        sort: sort,
        filter: filter
      })).organizations);
  ...
  return organizations_jsx(App["a" /* default */], {
    filters: data.filterOrganization,
    sorts: data.sortOrganization,
    pageName: "\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438"
  }, organizations_jsx(head_default.a, null, organizations_jsx("title", null, "\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438"), organizations_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/organizations`
  }), organizations_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/organizations`
  })), organizations_jsx("div", {
    className: classes.page
  }, list ? list.map(element => organizations_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: organizations_jsx(organization_CardOrganizationPlaceholder, {
      height: height
    })
  }, organizations_jsx(organization_CardOrganization, {
    key: element._id,
    setList: setList,
    element: element
  }))) : null), profile.role === 'admin' ? organizations_jsx(link_default.a, {
    href: "/organization/[id]",
    as: `/organization/new`
  }, organizations_jsx(Fab_default.a, {
    color: "primary",
    "aria-label": "add",
    className: classes.fab
  }, organizations_jsx(Add_default.a, null))) : null);
});

Organization.getInitialProps = async function () {
  return {
    data: await Object(organization["d" /* getOrganizations */])({
      search: '',
      sort: '-createdAt',
      filter: ''
    })
...
function organizations_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
function organizations_mapDispatchToProps(dispatch) {
  return {
    userActions: Object(external_redux_["bindActionCreators"])(user, dispatch)
  };
}

/* harmony default export */ var organizations = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(organizations_mapStateToProps, organizations_mapDispatchToProps)(Organization));
