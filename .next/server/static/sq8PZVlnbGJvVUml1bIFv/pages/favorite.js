...
module.exports = __webpack_require__("fGTc");
...
// CONCATENATED MODULE: ./src/styleMUI/favorite/favoriteList.js

/* harmony default export */ var favoriteList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// EXTERNAL MODULE: ./components/items/CardItem.js
var CardItem = __webpack_require__("XZkx");
...
// EXTERNAL MODULE: ./components/items/CardItemPlaceholder.js
var CardItemPlaceholder = __webpack_require__("vHpU");

// CONCATENATED MODULE: ./pages/favorite.js
...
const Items = external_react_default.a.memo(props => {
  const {
    authenticated
  } = props.user;
  const classes = favoriteList();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.favorites);
  const {
    search
  } = props.app;
  Object(external_react_["useEffect"])(() => {
    (async () => {
      ...
      } else setList((await Object(items["e" /* favorites */])({
        search: search
      })).favorites);
    })();
  }, [search]);
  ...
  let getList = async () => {
    setList((await Object(items["e" /* favorites */])({
      search: search
    })).favorites);
  };
  ...
  return __jsx(App["a" /* default */], {
    getList: getList,
    pageName: "\u0418\u0437\u0431\u0440\u0430\u043D\u043D\u043E\u0435"
  }, __jsx(head_default.a, null, __jsx("title", null, "\u0418\u0437\u0431\u0440\u0430\u043D\u043D\u043E\u0435"), __jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/favorite`
  }), __jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/favorite`
  })), __jsx("div", {
    className: classes.page
  }, list ? list.map(element => __jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: __jsx(CardItemPlaceholder["a" /* default */], null)
  }, __jsx(CardItem["a" /* default */], {
    setList: setList,
...
Items.getInitialProps = async function (ctx) {
  ...
  return {
    data: await Object(items["e" /* favorites */])({
      search: ''
    })
  };
};
...
/* harmony default export */ var favorite = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps)(Items));
