...
module.exports = __webpack_require__("o/ek");
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getBonuses; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return setBonus; });
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("YvTO");
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(apollo_boost__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _singleton_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("gIpB");
/* harmony import */ var _singleton_store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("gs4i");
...
const setBonus = async element => {
  try {
    ...
    let list = await getBonuses(new _singleton_store__WEBPACK_IMPORTED_MODULE_2__[/* SingletonStore */ "a"]().getStore().getState().app);
    return list;
  } catch (err) {
    console.error(err);
  }
...
// EXTERNAL MODULE: ./src/gql/bonus.js
var bonus = __webpack_require__("dU2l");

// EXTERNAL MODULE: ./src/styleMUI/bonus/bonusList.js
var bonusList = __webpack_require__("NgRk");
...
// EXTERNAL MODULE: ./src/styleMUI/bonus/cardBonus.js
var cardBonus = __webpack_require__("UEjT");
...
// CONCATENATED MODULE: ./components/bonus/CardBonus.js
var __jsx = external_react_default.a.createElement;
...
const CardBonus = external_react_default.a.memo(props => {
  const classes = Object(cardBonus["a" /* default */])();
  const {
    element,
    setList
  } = props;
  ...
  let {
    0: target,
    1: setTarget
  } = Object(external_react_["useState"])(element ? element.target : 0);
  let {
    0: bonus1,
    1: setBonus1
  } = Object(external_react_["useState"])(element ? element.bonus : 0);
  return __jsx(Card_default.a, {
  ...
  }, element.organization.name), __jsx("br", null), ['организация', 'менеджер', 'admin'].includes(profile.role) ? __jsx(external_react_default.a.Fragment, null, __jsx(TextField_default.a, {
    style: {
      width: '100%'
    },
    label: "\u0426\u0435\u043B\u044C",
    ...
    onChange: event => {
      setTarget(Object(lib["b" /* checkInt */])(event.target.value));
    },
    inputProps: {
      'aria-label': 'description'
    }
    ...
    className: classes.input,
    onChange: event => {
      setBonus1(Object(lib["b" /* checkInt */])(event.target.value));
    },
    inputProps: {
      'aria-label': 'description'
    }
  }), __jsx("br", null)) : __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    className: classes.row
  }, __jsx("div", {
    className: classes.nameField
  }, "\u0426\u0435\u043B\u044C:\xA0"), __jsx("div", {
    className: classes.value
  }, element.target, "\xA0\u0441\u043E\u043C")), __jsx("div", {
    className: classes.row
  }, __jsx("div", {
    className: classes.nameField
  }, "\u0411\u043E\u043D\u0443\u0441:\xA0"), __jsx("div", {
    className: classes.value
  }, element.bonus, "\xA0\u0441\u043E\u043C")))))), ['организация', 'менеджер', 'admin'].includes(profile.role) ? __jsx(CardActions_default.a, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        const list = (await Object(bonus["b" /* setBonus */])({
          _id: element._id,
          target: target,
          bonus: bonus1
        })).bonuses;
...
/* harmony default export */ var bonus_CardBonus = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardBonus));
...
// CONCATENATED MODULE: ./components/bonus/CardBonusPlaceholder.js
var CardBonusPlaceholder_jsx = external_react_default.a.createElement;




const CardBlogPlaceholder = external_react_default.a.memo(props => {
  const classes = Object(cardBonus["a" /* default */])();
  const {
    height
  } = props;
  ...
  return CardBonusPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, CardBonusPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardBonusPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var CardBonusPlaceholder = (Object(external_react_redux_["connect"])(CardBonusPlaceholder_mapStateToProps)(CardBlogPlaceholder));
// CONCATENATED MODULE: ./pages/bonus.js
var bonus_jsx = external_react_default.a.createElement;
...
const Bonus = external_react_default.a.memo(props => {
  const classes = Object(bonusList["a" /* default */])();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.bonuses);
  const {
    search,
    sort
  } = props.app;
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(bonus["a" /* getBonuses */])({
        search: search,
        sort: sort
      })).bonuses);
    })();
  }, [sort, search]);
  return bonus_jsx(App["a" /* default */], {
    sorts: data.sortBonus,
    pageName: ['организация', 'менеджер'].includes(profile.role) ? 'Бонусы компании' : 'Бонусы компаний'
  }, bonus_jsx(head_default.a, null, bonus_jsx("title", null, ['организация', 'менеджер'].includes(profile.role) ? 'Бонусы компании' : 'Бонусы компаний'), bonus_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/bonus`
  }), bonus_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/bonus`
  })), bonus_jsx("div", {
    className: classes.page
  }, list ? list.map(element => bonus_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: bonus_jsx(CardBonusPlaceholder, {
      height: height
    })
  }, bonus_jsx(bonus_CardBonus, {
    key: element._id,
    setList: setList,
    element: element
  }))) : null));
...
Bonus.getInitialProps = async function () {
  return {
    data: await Object(bonus["a" /* getBonuses */])({
      search: '',
      sort: '-createdAt'
    })
  };
...
function bonus_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
function bonus_mapDispatchToProps(dispatch) {
  return {
    userActions: Object(external_redux_["bindActionCreators"])(user, dispatch)
  };
}

/* harmony default export */ var pages_bonus = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(bonus_mapStateToProps, bonus_mapDispatchToProps)(Bonus));
