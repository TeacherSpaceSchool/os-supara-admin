...
// CONCATENATED MODULE: ./src/styleMUI/orders/orderList.js

/* harmony default export */ var orderList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./components/order/CardOrderPlaceholder.js
var __jsx = external_react_default.a.createElement;



const CardOrderPlaceholder = external_react_default.a.memo(() => {
...
/* harmony default export */ var order_CardOrderPlaceholder = (CardOrderPlaceholder);
...
const Orders = external_react_default.a.memo(props => {
  const classes = orderList();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.invoices);
  const {
    search,
    filter,
    sort,
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(order["d" /* getOrders */])({
        search: search,
        sort: sort,
        filter: filter,
        date: date
  ...
  return orders_jsx(App["a" /* default */], {
    dates: true,
    filters: data.filterInvoice,
    sorts: data.sortInvoice,
    pageName: "\u0417\u0430\u043A\u0430\u0437\u044B"
  }, orders_jsx(head_default.a, null, orders_jsx("title", null, "\u0417\u0430\u043A\u0430\u0437\u044B"), orders_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/orders`
  }), orders_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/orders`
  })), orders_jsx("div", {
    className: classes.page
  }, list ? list.map(element => orders_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: orders_jsx(order_CardOrderPlaceholder, null)
  }, orders_jsx(CardOrder["a" /* default */], {
    setList: setList,
    key: element._id,
    element: element
  }))) : null));
...
Orders.getInitialProps = async function (ctx) {
  ...
  return {
    data: await Object(order["d" /* getOrders */])({
      search: '',
      sort: '-createdAt',
      filter: '',
      date: ''
...
/* harmony default export */ var orders = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps)(Orders));
