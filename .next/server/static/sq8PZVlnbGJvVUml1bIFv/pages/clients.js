...
// CONCATENATED MODULE: ./src/styleMUI/client/clientList.js

/* harmony default export */ var clientList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./src/styleMUI/client/cardClient.js

/* harmony default export */ var cardClient = (Object(styles_["makeStyles"])({
  cardM: {
...
// CONCATENATED MODULE: ./components/client/CardClient.js
...
const CardOrganization = external_react_default.a.memo(props => {
  ...
  let {
    0: status,
    1: setStatus
  } = Object(external_react_["useState"])(element.user.status);
  return __jsx(Card_default.a, {
    ...
    className: classes.nameField
  }, "\u0410\u0434\u0440\u0435\u0441:\xA0"), __jsx("div", null, element.address.map((addres, idx) => __jsx("div", {
    key: idx,
    className: classes.value
  }, addres[0])))))))), __jsx(CardActions_default.a, null, profile.role === 'admin' ? __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(client["c" /* onoffClient */])([element._id]);
...
/* harmony default export */ var CardClient = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardOrganization));
...
// CONCATENATED MODULE: ./components/client/CardClientPlaceholder.js
var CardClientPlaceholder_jsx = external_react_default.a.createElement;




const CardClientPlaceholder = external_react_default.a.memo(props => {
  const classes = cardClient();
  const {
    isMobileApp
  } = props.app;
  const height = 140;
  return CardClientPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, CardClientPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardClientPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var client_CardClientPlaceholder = (Object(external_react_redux_["connect"])(CardClientPlaceholder_mapStateToProps)(CardClientPlaceholder));
...
const clients_height = 140;
const Client = external_react_default.a.memo(props => {
  const classes = clientList();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.clients);
  const {
    search,
    filter,
    sort
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(client["b" /* getClients */])({
        search: search,
        sort: sort,
        filter: filter
      })).clients);
  ...
  return clients_jsx(App["a" /* default */], {
    filters: data.filterClient,
    sorts: data.sortClient,
    pageName: "\u041A\u043B\u0438\u0435\u043D\u0442\u044B"
  }, clients_jsx(head_default.a, null, clients_jsx("title", null, "\u041A\u043B\u0438\u0435\u043D\u0442\u044B"), clients_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/clients`
  }), clients_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/clients`
  })), clients_jsx("div", {
    className: classes.page
  }, list ? list.map(element => clients_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: clients_height,
    offset: [clients_height, 0],
    debounce: 100,
    placeholder: clients_jsx(client_CardClientPlaceholder, {
      height: clients_height
    })
  }, clients_jsx(CardClient, {
    key: element._id,
    setList: setList,
    element: element
  }))) : null));
...
Client.getInitialProps = async function (ctx) {
  ...
  return {
    data: await Object(client["b" /* getClients */])({
      search: '',
      sort: '-createdAt',
      filter: ''
    })
...
function clients_mapStateToProps(state) {
  return {
    app: state.app,
    user: state.user
  };
...
/* harmony default export */ var clients = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(clients_mapStateToProps)(Client));
