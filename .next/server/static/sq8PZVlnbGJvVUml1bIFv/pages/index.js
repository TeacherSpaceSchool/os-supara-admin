...
var category = __webpack_require__("syjg");

// EXTERNAL MODULE: external "@material-ui/core/styles"
var styles_ = __webpack_require__("9Pu4");

// CONCATENATED MODULE: ./src/styleMUI/category/categoryList.js

/* harmony default export */ var categoryList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./src/styleMUI/category/cardCategory.js

/* harmony default export */ var cardCategory = (Object(styles_["makeStyles"])({
  cardM: {
...
// CONCATENATED MODULE: ./components/category/CardCategory.js
...
const CardCategory = external_react_default.a.memo(props => {
  ...
  return __jsx(Card_default.a, {
  ...
  }, name !== 'Не задано' && setList !== 'all' && profile.role === 'admin' ? __jsx(external_react_default.a.Fragment, null, __jsx(CardActionArea_default.a, null, __jsx(CardContent_default.a, null, __jsx("div", {
    ...
    onClick: async () => {
      ...
      const action = async () => {
        setList((await Object(category["e" /* setCategory */])(editElement)).categorys);
      };
    ...
    onClick: async () => {
      const action = async () => {
        setList((await Object(category["d" /* onoffCategory */])([element._id])).categorys);
      };
    ...
    size: "small",
    color: "primary"
  }, element.status === 'active' ? 'Отключить' : 'Включить'), __jsx(Button_default.a, {
    size: "small",
    color: "primary",
    onClick: () => {
      const action = async () => {
        setList((await Object(category["b" /* deleteCategory */])([element._id])).categorys);
      };
    ...
    onClick: async () => {
      if (image !== undefined && name.length > 0) {
        ...
        const action = async () => {
          setList((await Object(category["a" /* addCategory */])({
            image: image,
            name: name
          })).categorys);
        };
  ...
  })) : name !== 'Не задано' ? __jsx(CardActionArea_default.a, null, __jsx(CardContent_default.a, null, __jsx(link_default.a, {
    href: "/subcategory/[id]",
    as: `/subcategory/${element._id}`
  }, __jsx("div", {
    className: classes.line
    ...
    className: isMobileApp ? classes.inputM : classes.inputD
  }, element.name))))) : name === 'Не задано' && profile.role === 'admin' ? __jsx(CardActionArea_default.a, null, __jsx(CardContent_default.a, null, __jsx(link_default.a, {
    href: "/subcategory/[id]",
    as: `/subcategory/${element._id}`
  }, __jsx("div", {
    className: classes.line
...
/* harmony default export */ var category_CardCategory = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardCategory));
...
// CONCATENATED MODULE: ./components/category/CardCategoryPlaceholder.js
var CardCategoryPlaceholder_jsx = external_react_default.a.createElement;




const CardCategoryPlaceholder = external_react_default.a.memo(props => {
  const classes = cardCategory();
  const {
    height
  } = props;
  ...
  return CardCategoryPlaceholder_jsx("div", {
    className: isMobileApp ? classes.cardM : classes.cardD,
    style: {
      height: height
    }
  }, CardCategoryPlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardCategoryPlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var category_CardCategoryPlaceholder = (Object(external_react_redux_["connect"])(CardCategoryPlaceholder_mapStateToProps)(CardCategoryPlaceholder));
...
const Index = external_react_default.a.memo(props => {
  const classes = categoryList();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.categorys);
  const {
    search,
    filter,
    sort
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(category["c" /* getCategorys */])({
        search: search,
        sort: sort,
        filter: filter
      })).categorys);
  ...
  Object(external_react_["useEffect"])(() => {
    if (!(!authenticated || ['admin', 'client'].includes(profile.role) || !profile.role)) router_default.a.push('/items/all');
  }, [profile, authenticated]);
  return pages_jsx(App["a" /* default */], {
    filters: data.filterCategory,
    sorts: data.sortCategory,
    pageName: "\u0422\u043E\u0432\u0430\u0440\u044B"
  }, pages_jsx(head_default.a, null, pages_jsx("title", null, "\u0410\u0437\u044B\u043A - \u044D\u043B\u0435\u043A\u0442\u0440\u043E\u043D\u043D\u044B\u0439 \u0441\u043A\u043B\u0430\u0434 \u0441\u0432\u044F\u0437\u044B\u0432\u0430\u044E\u0449\u0438\u0439 \u043F\u0440\u043E\u0438\u0437\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044F \u0441 \u0442\u043E\u0440\u0433\u043E\u0432\u043E\u0439 \u0442\u043E\u0447\u043A\u043E\u0439"), pages_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}`
  }), pages_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}`
  })), pages_jsx("div", {
    className: classes.page
  }, profile.role === 'admin' ? pages_jsx(external_react_default.a.Fragment, null, pages_jsx(category_CardCategory, {
    setList: setList
  })) : null, pages_jsx(category_CardCategory, {
    element: {
    ...
    setList: "all"
  }), list ? list.map(element => element.name !== 'Не задано' ? pages_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: pages_jsx(category_CardCategoryPlaceholder, {
      height: height
    })
  }, pages_jsx(category_CardCategory, {
    key: element._id,
    setList: setList,
    element: element
  })) : null) : null));
...
Index.getInitialProps = async function (ctx) {
  ...
  if (!(!authenticated || ['admin', 'client'].includes(role) || !role)) if (ctx.res) {
    ...
    ctx.res.end();
  } else router_default.a.push('/items/all');
  return {
    data: await Object(category["c" /* getCategorys */])({
      search: '',
      sort: '-createdAt',
      filter: ''
    })
