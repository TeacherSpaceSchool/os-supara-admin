...
module.exports = __webpack_require__("hTbD");
...
// CONCATENATED MODULE: ./src/styleMUI/route/cardRoute.js

/* harmony default export */ var cardRoute = (Object(styles_["makeStyles"])({
  card: {
    width: 400,
    margin: 10,
    position: 'relative'
...
// CONCATENATED MODULE: ./components/route/CardRoute.js
var __jsx = external_react_default.a.createElement;
...
const CardOrder = external_react_default.a.memo(props => {
  ...
  return __jsx(Card_default.a, {
    ...
    className: classes.value
  }, Object(lib["e" /* pdDDMMYY */])(new Date(element.dateStart)))), __jsx("div", {
    className: classes.row
  }, __jsx("div", {
    className: classes.nameField
    ...
    key: idx,
    className: classes.value
  }, invoice.number))))))), __jsx(CardActions_default.a, null, ['организация', 'менеджер', 'admin'].includes(profile.role) && element.status === 'создан' ? __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        setList((await Object(route["b" /* deleteRoute */])([element._id])).routes);
      };
...
/* harmony default export */ var CardRoute = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardOrder));
// CONCATENATED MODULE: ./src/styleMUI/route/routeList.js

/* harmony default export */ var routeList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./components/route/CardRoutePlaceholder.js
var CardRoutePlaceholder_jsx = external_react_default.a.createElement;




const CardRoutePlaceholder = external_react_default.a.memo(props => {
  const classes = cardRoute();
  return CardRoutePlaceholder_jsx("div", {
    className: classes.card,
    style: {
      height: 210
    }
  }, CardRoutePlaceholder_jsx(Skeleton_default.a, {
    variant: "rect",
    height: "100%"
  }));
});

function CardRoutePlaceholder_mapStateToProps(state) {
  return {
    user: state.user,
    app: state.app
  };
...
/* harmony default export */ var route_CardRoutePlaceholder = (Object(external_react_redux_["connect"])(CardRoutePlaceholder_mapStateToProps)(CardRoutePlaceholder));
// CONCATENATED MODULE: ./pages/routes.js
var routes_jsx = external_react_default.a.createElement;
...
const Routes = external_react_default.a.memo(props => {
  const {
    profile
  } = props.user;
  const classes = routeList();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.routes);
  const {
    search,
    filter,
    sort,
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(route["d" /* getRoutes */])({
        search: search,
        sort: sort,
        filter: filter,
        date: date
  ...
  return routes_jsx(App["a" /* default */], {
    dates: true,
    filters: data.filterRoute,
    sorts: data.sortRoute,
    pageName: "\u041C\u0430\u0440\u0448\u0440\u0443\u0442\u043D\u044B\u0435 \u043B\u0438\u0441\u0442\u044B"
  }, routes_jsx(head_default.a, null, routes_jsx("title", null, "\u041C\u0430\u0440\u0448\u0440\u0443\u0442\u043D\u044B\u0435 \u043B\u0438\u0441\u0442\u044B"), routes_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/routes`
  }), routes_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/routes`
  })), routes_jsx("div", {
    className: classes.page
  }, list ? list.map(element => routes_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: routes_jsx(route_CardRoutePlaceholder, null)
  }, routes_jsx(CardRoute, {
    setList: setList,
    key: element._id,
    element: element
  }))) : null), ['admin', 'организация', 'менеджер'].includes(profile.role) ? routes_jsx(link_default.a, {
    href: "/route/[id]",
    as: `/route/new`
  }, routes_jsx(Fab_default.a, {
    color: "primary",
    "aria-label": "add",
    className: classes.fab
  }, routes_jsx(Add_default.a, null))) : null);
});
...
Routes.getInitialProps = async function (ctx) {
  ...
  return {
    data: await Object(route["d" /* getRoutes */])({
      search: '',
      sort: '-createdAt',
      filter: '',
      date: ''
...
function routes_mapStateToProps(state) {
  return {
    app: state.app,
    user: state.user,
    pagination: state.pagination
...
/* harmony default export */ var routes = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(routes_mapStateToProps)(Routes));
