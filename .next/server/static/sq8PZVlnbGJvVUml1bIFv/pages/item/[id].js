...
module.exports = __webpack_require__("NR8C");
...
// EXTERNAL MODULE: ./src/gql/subcategory.js
var subcategory = __webpack_require__("x8ZX");
...
// CONCATENATED MODULE: ./src/styleMUI/item/item.js

/* harmony default export */ var item = (Object(styles_["makeStyles"])({
  page: {
    margin: '20px'
  },
  row: {
...
// CONCATENATED MODULE: ./components/dialog/DeliveryDays.js
...
const DeliveryDays = external_react_default.a.memo(props => {
  const {
    classes,
    deliveryDays,
    setDeliveryDays,
  ...
  } = Object(external_react_["useState"])(deliveryDays);
  ...
  })), __jsx("br", null), __jsx("div", null, edit ? __jsx(Button_default.a, {
    variant: "contained",
    color: "primary",
    onClick: async () => {
  ...
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C") : null, __jsx(Button_default.a, {
    variant: "contained",
    color: "secondary",
    onClick: () => {
      showMiniDialog(false);
...
/* harmony default export */ var dialog_DeliveryDays = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Object(styles_["withStyles"])(dialogContent["a" /* default */])(DeliveryDays)));
// CONCATENATED MODULE: ./pages/item/[id].js
...
const Item = external_react_default.a.memo(props => {
  const classes = item();
  const {
    data
  } = props;
  ...
  let {
    0: stock,
    1: setStock
  } = Object(external_react_["useState"])(data.item !== null ? data.item.stock : '');
  let {
    0: name,
    1: setName
  } = Object(external_react_["useState"])(data.item !== null ? data.item.name : '');
  let {
    0: info,
    1: setInfo
  } = Object(external_react_["useState"])(data.item !== null ? data.item.info : '');
  let {
    0: price,
    1: setPrice
  } = Object(external_react_["useState"])(data.item !== null ? data.item.price : '');
  let {
    0: deliveryDays,
    1: setDeliveryDays
  } = Object(external_react_["useState"])(data.item !== null ? data.item.deliveryDays : []);
  let {
    0: subCategory,
    1: setSubCategory
  } = Object(external_react_["useState"])(data.item !== null ? data.item.subCategory : {});
  let {
    0: status,
    1: setStatus
  } = Object(external_react_["useState"])(data.item !== null ? data.item.status : '');
  ...
  let {
    0: organization,
    1: setOrganization
  } = Object(external_react_["useState"])(data.item !== null ? data.item.organization : {});
  ...
  let {
    0: hit,
    1: setHit
  } = Object(external_react_["useState"])(data.item !== null ? data.item.hit : false);
  let {
    0: latest,
    1: setLatest
  } = Object(external_react_["useState"])(data.item !== null ? data.item.latest : false);
  let {
    0: preview,
    1: setPreview
  } = Object(external_react_["useState"])(data.item !== null ? data.item.image : '');
  let {
    0: image,
    1: setImage
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      if (['организация', 'менеджер', 'экспедитор'].includes(profile.role)) {
        let employment = (await Object(gql_employment["d" /* getEmployment */])({
          _id: profile._id
        })).employment;
  ...
  Object(external_react_["useEffect"])(() => {
    if (!authenticated) {
      if (localStorage.favorites == undefined) localStorage.favorites = stringify_default()([]);else if (data.item !== null) {
      ...
      if (localStorage.basket == undefined) localStorage.basket = stringify_default()([]);
    }
  }, []); //BUY
  ...
  let {
    0: favorite,
    1: setFavorite
  } = Object(external_react_["useState"])(data.item !== null && data.item.favorite !== undefined ? data.item.favorite : []);
  ...
  return _id_jsx(App["a" /* default */], {
  ...
  }, _id_jsx(head_default.a, null, _id_jsx("title", null, data.item !== null ? router.query.id === 'new' ? 'Добавить' : data.item.name : 'Ничего не найдено'), _id_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/item/${router.query.id}`
  }), _id_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/item/${router.query.id}`
  })), _id_jsx(Card_default.a, {
    className: classes.page
  }, _id_jsx(CardContent_default.a, {
    className: isMobileApp ? classes.column : classes.row
  }, profile.role === 'admin' || ['менеджер', 'организация'].includes(profile.role) && data.item.organization._id === employment.organization._id ? data.item !== null || router.query.id === 'new' ? _id_jsx(external_react_default.a.Fragment, null, _id_jsx("label", {
    htmlFor: "contained-button-file"
  }, _id_jsx("img", {
    className: isMobileApp ? classes.mediaM : classes.mediaD,
    src: preview,
    alt: 'Добавить'
  })), _id_jsx("div", null, _id_jsx("h1", {
    className: classes.name
  }, _id_jsx(TextField_default.a, {
    label: "\u0418\u043C\u044F",
    value: name,
    ...
    className: isMobileApp ? classes.inputM : classes.inputD,
    onChange: event => {
      setPrice(Object(lib["b" /* checkInt */])(event.target.value));
    },
    inputProps: {
      'aria-label': 'description'
    }
    ...
    className: isMobileApp ? classes.inputM : classes.inputD,
    onChange: event => {
      setStock(Object(lib["b" /* checkInt */])(event.target.value));
    },
    inputProps: {
      'aria-label': 'description'
    }
  })), profile.role === 'admin' ? _id_jsx(FormControl_default.a, {
    className: isMobileApp ? classes.inputM : classes.inputD
    ...
    value: element._id,
    ola: element.name
  }, element.name)))) : _id_jsx(Input_default.a, {
  ...
  }), _id_jsx("br", null), _id_jsx(Button_default.a, {
    size: "small",
    color: "primary",
    onClick: () => {
      setMiniDialog('Дни поставки', _id_jsx(dialog_DeliveryDays, {
  ...
  }, "\u0414\u043D\u0438 \u043F\u043E\u0441\u0442\u0430\u0432\u043A\u0438 \u0434\u043B\u044F \u0442\u043E\u0440\u0433\u043E\u0432\u044B\u0445 \u0442\u043E\u0447\u0435\u043A"), _id_jsx("br", null), _id_jsx("br", null), _id_jsx(FormControl_default.a, {
    className: isMobileApp ? classes.inputM : classes.inputD
  }, _id_jsx(InputLabel_default.a, null, "\u041F\u043E\u0434\u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F"), _id_jsx(Select_default.a, {
    value: subCategory._id,
    onChange: handleSubCategory
  }, data.subCategorys.map(element => _id_jsx(MenuItem_default.a, {
    key: element._id,
    value: element._id,
    ola: element.name
  }, element.name)))), _id_jsx("br", null), profile.role === 'admin' ? _id_jsx(external_react_default.a.Fragment, null, _id_jsx("div", {
    className: classes.row
  }, _id_jsx(FormControlLabel_default.a, {
    control: _id_jsx(Switch_default.a, {
      checked: hit,
      onChange: () => {
        setHit(!hit);
      },
    ...
    label: "\u041D\u043E\u0432\u0438\u043D\u043A\u0430"
  })), _id_jsx("br", null)) : null, _id_jsx(TextField_default.a, {
    multiline: true,
    label: "\u0418\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F",
    value: info,
    className: isMobileApp ? classes.inputM : classes.inputD,
    ...
    onClick: async () => {
      if (name.length > 0 && price > 0 && subCategory._id != undefined && organization._id != undefined) {
        const action = async () => {
          ...
          router_default.a.push(`/items/${subCategory._id}`);
        };
    ...
    onClick: async () => {
      ...
      const action = async () => {
        await Object(items["j" /* setItem */])(editElement, subCategory._id); //Router.push(`/items/${subCategory._id}`)
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), _id_jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(items["i" /* onoffItem */])([data.item._id]);
    ...
    size: "small",
    color: "primary"
  }, status === 'active' ? 'Отключить' : 'Включить'), profile.role === 'admin' ? _id_jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(items["c" /* deleteItem */])([data.item._id], subCategory._id);
        router_default.a.push(`/items/${subCategory._id}`);
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C") : null)))) : 'Ничего не найдено' : data.item === null || router.query.id === 'new' ? 'Ничего не найдено' : _id_jsx(external_react_default.a.Fragment, null, _id_jsx("div", {
    className: classes.divImage
  }, _id_jsx("img", {
    className: isMobileApp ? classes.mediaM : classes.mediaD,
    src: data.item.image,
    alt: data.item.info
  }), profile.role === 'client' || !authenticated ? _id_jsx(Star_default.a, {
    className: classes.buttonToggle,
    onClick: async () => {
      let index;

      if (profile.role === 'client') {
        await Object(items["d" /* favoriteItem */])([data.item._id]);
        ...
        if (index === -1) {
          ...
          setFavorite(true);
          localStorage.favorites = stringify_default()(favorites);
        }
      }
  ...
  }) : null), _id_jsx("div", null, isMobileApp ? _id_jsx("br", null) : null, _id_jsx("h1", {
    className: classes.name
  }, data.item.name), _id_jsx("div", {
    className: classes.share
  }, data.item.organization.name), _id_jsx("div", {
  ...
  }, "\u0414\u043D\u0438 \u043F\u043E\u0441\u0442\u0430\u0432\u043A\u0438 \u0434\u043B\u044F \u0442\u043E\u0440\u0433\u043E\u0432\u044B\u0445 \u0442\u043E\u0447\u0435\u043A"), _id_jsx("br", null), _id_jsx("div", {
    className: classes.row
  }, data.item.stock === 0 || data.item.stock === undefined ? _id_jsx("div", {
    className: classes.price
  }, data.item.price, "\xA0\u0441\u043E\u043C") : _id_jsx(external_react_default.a.Fragment, null, _id_jsx("div", {
    className: classes.stockPrice
  }, data.item.stock, "\xA0\u0441\u043E\u043C"), _id_jsx("div", {
    className: classes.crossedPrice
  }, data.item.price, "\xA0\u0441\u043E\u043C"))), _id_jsx("br", null), profile.role === 'client' || !authenticated ? _id_jsx(external_react_default.a.Fragment, null, _id_jsx("div", {
    ...
    value: count,
    onChange: event => {
      setCount(isNaN(event.target.value) || event.target.value.length === 0 ? 0 : parse_int_default()(event.target.value));
    }
  }), _id_jsx("div", {
    className: classes.counterbtn,
    onClick: increment
    ...
    className: classes.button,
    onClick: () => {
      if (profile.role === 'client') Object(gql_basket["a" /* addBasket */])({
        item: data.item._id,
        ...
        localStorage.basket = stringify_default()(basket);
      }
      showSnackBar('Товар добавлен в корзину');
      Object(gql_basket["d" /* getCountBasket */])();
    }
  }, "\u0412 \u041A\u041E\u0420\u0417\u0418\u041D\u0423")), _id_jsx("br", null), _id_jsx("div", {
    className: classes.share
  }, "\u041F\u043E\u0434\u0435\u043B\u0438\u0442\u044C\u0441\u044F:"), _id_jsx("div", {
    className: classes.rowCenter
  }, _id_jsx(external_react_share_["FacebookShareButton"], {
    url:  false ? undefined : ''
  }, _id_jsx(external_react_share_["FacebookIcon"], {
    size: 32,
    round: true
  })), "\xA0 \xA0", _id_jsx(external_react_share_["VKShareButton"], {
    url:  false ? undefined : ''
  }, _id_jsx(external_react_share_["VKIcon"], {
    size: 32,
    round: true
  })), "\xA0 \xA0", _id_jsx(external_react_share_["OKShareButton"], {
    url:  false ? undefined : ''
  }, _id_jsx(external_react_share_["OKIcon"], {
    size: 32,
    round: true
  })), "\xA0 \xA0", _id_jsx(external_react_share_["WhatsappShareButton"], {
    url:  false ? undefined : ''
  }, _id_jsx(external_react_share_["WhatsappIcon"], {
    size: 32,
    round: true
  })), "\xA0 \xA0", _id_jsx(external_react_share_["TelegramShareButton"], {
    url:  false ? undefined : ''
  }, _id_jsx(external_react_share_["TelegramIcon"], {
    size: 32,
    round: true
  })))) : null)))), _id_jsx("input", {
    accept: "image/*",
...
Item.getInitialProps = async function (ctx) {
  return {
    data: Object(objectSpread["a" /* default */])({}, ctx.query.id !== 'new' ? await Object(items["g" /* getItem */])({
      _id: ctx.query.id
    }) : {
      item: {
      ...
      sort: 'name',
      filter: ''
    })), (await Object(subcategory["b" /* getSubCategorys */])({
      category: 'all',
      search: '',
      sort: 'name',
      filter: ''
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(_id_mapStateToProps, _id_mapDispatchToProps)(Item));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getSubCategorys; });
/* unused harmony export deleteSubCategory */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return onoffSubCategory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addSubCategory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return setSubCategory; });
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("zrwo");
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("YvTO");
/* harmony import */ var apollo_boost__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(apollo_boost__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _singleton_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("gIpB");
...
const deleteSubCategory = async (ids, category) => {
  try {
    ...
    return await getSubCategorys(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({
      category: category
    }, new _singleton_store__WEBPACK_IMPORTED_MODULE_3__[/* SingletonStore */ "a"]().getStore().getState().app));
  } catch (err) {
    console.error(err);
