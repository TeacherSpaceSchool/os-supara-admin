...
module.exports = __webpack_require__("YkT5");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getAdss; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return setAds; });
...
/* harmony import */ var _material_ui_core_Card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("YeXC");
/* harmony import */ var _material_ui_core_Card__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _material_ui_core_CardActionArea__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("lOH7");
...
/* harmony import */ var _src_styleMUI_ads_cardAds__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("XhOy");
...
/* harmony import */ var _src_gql_ads__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("7Ma4");
...
/* harmony import */ var _dialog_Confirmation__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("y4xb");
...
const CardAds = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(props => {
  const classes = Object(_src_styleMUI_ads_cardAds__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])();
  const {
    element,
    setList
  } = props;
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, " ", profile.role === 'admin' ? __jsx(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_1___default.a, {
    ...
    src: preview,
    alt: 'Изменить'
  })), __jsx(_material_ui_core_CardContent__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx(_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_9___default.a, {
    label: "\u0418\u043C\u044F",
    value: title,
  ...
  }), __jsx("br", null), __jsx("br", null), __jsx(_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_9___default.a, {
    label: "URL",
    value: url,
    className: classes.input,
    onChange: handleUrl,
  ...
  })), __jsx(_material_ui_core_CardActions__WEBPACK_IMPORTED_MODULE_7___default.a, null, element !== undefined ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
    onClick: async () => {
      let editElement = {
        _id: element._id
      };
      ...
      const action = async () => {
        setList((await Object(_src_gql_ads__WEBPACK_IMPORTED_MODULE_8__[/* setAds */ "d"])(editElement)).adss);
      };

      setMiniDialog('Вы уверенны?', __jsx(_dialog_Confirmation__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"], {
        action: action
      }));
      showMiniDialog(true);
    },
    ...
    onClick: async () => {
      const action = async () => {
        setList((await Object(_src_gql_ads__WEBPACK_IMPORTED_MODULE_8__[/* deleteAds */ "b"])([element._id])).adss);
      };
    ...
    onClick: async () => {
      if (image !== undefined && url.length > 0 && title.length > 0) {
        ...
        const action = async () => {
          setList((await Object(_src_gql_ads__WEBPACK_IMPORTED_MODULE_8__[/* addAds */ "a"])({
            image: image,
            url: url,
            title: title
          })).adss);
...
/* harmony default export */ __webpack_exports__["a"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["connect"])(mapStateToProps, mapDispatchToProps)(CardAds));
...
// EXTERNAL MODULE: ./components/ads/CardAds.js
var CardAds = __webpack_require__("Ha6T");

// EXTERNAL MODULE: external "@material-ui/core/styles"
var styles_ = __webpack_require__("9Pu4");

// CONCATENATED MODULE: ./src/styleMUI/ads/adsList.js

/* harmony default export */ var adsList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// EXTERNAL MODULE: ./src/styleMUI/ads/cardAds.js
var cardAds = __webpack_require__("XhOy");
...
// CONCATENATED MODULE: ./components/ads/CardAdsPlaceholder.js
var __jsx = external_react_default.a.createElement;




const CardAdsPlaceholder = external_react_default.a.memo(props => {
  const classes = Object(cardAds["a" /* default */])();
  const {
    height
  } = props;
  const {
...
/* harmony default export */ var ads_CardAdsPlaceholder = (Object(external_react_redux_["connect"])(mapStateToProps)(CardAdsPlaceholder));
// CONCATENATED MODULE: ./pages/ads.js
...
const Ads = external_react_default.a.memo(props => {
  const classes = adsList();
  const {
    data
  } = props;
  let {
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(ads["c" /* getAdss */])({
        search: search,
        sort: sort,
        filter: filter
      })).adss);
  ...
  return ads_jsx(App["a" /* default */], {
    filters: data.filterAds,
    sorts: data.sortAds,
    pageName: "\u0410\u043A\u0446\u0438\u0438"
  }, ads_jsx(head_default.a, null, ads_jsx("title", null, "\u0410\u043A\u0446\u0438\u0438"), ads_jsx("meta", {
    name: "description",
    ...
    property: "og:url",
    content: `${other["b" /* urlMain */]}/ads`
  }), ads_jsx("link", {
    rel: "canonical",
    href: `${other["b" /* urlMain */]}/ads`
  })), ads_jsx("div", {
    className: classes.page
  }, profile.role === 'admin' ? ads_jsx(CardAds["a" /* default */], {
    setList: setList
  }) : null, list ? list.map(element => ads_jsx(external_react_lazyload_default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 100,
    placeholder: ads_jsx(ads_CardAdsPlaceholder, {
      height: height
    })
  }, ads_jsx(CardAds["a" /* default */], {
    setList: setList,
    key: element._id,
    element: element
  }))) : null));
...
Ads.getInitialProps = async function (ctx) {
  ...
  return {
    data: await Object(ads["c" /* getAdss */])({
      search: '',
      sort: '-createdAt',
      filter: ''
    })
...
function ads_mapStateToProps(state) {
  return {
    app: state.app,
    user: state.user,
...
/* harmony default export */ var pages_ads = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(ads_mapStateToProps)(Ads));
