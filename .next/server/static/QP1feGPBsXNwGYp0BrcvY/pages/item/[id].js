...
const Item = external_react_default.a.memo(props => {
  ...
  return __jsx(App["a" /* default */], {
  ...
  }, __jsx(head_default.a, null, __jsx("title", null, data.item !== null ? router.query.id === 'new' ? 'Добавить' : data.item.name : 'Ничего не найдено')), __jsx(Card_default.a, {
    className: classes.page
  }, __jsx(CardContent_default.a, {
    className: isMobileApp ? classes.column : classes.row
  }, profile.role === 'admin' || router.query.id === 'new' || ['менеджер', 'организация'].includes(profile.role) && data.item.organization._id === employment.organization._id ? data.item !== null || router.query.id === 'new' ? __jsx(external_react_default.a.Fragment, null, __jsx("label", {
  ...
  })), profile.role === 'admin' ? __jsx(FormControl_default.a, {
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(InputLabel_default.a, null, "\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u044F"), __jsx(Select_default.a, {
    value: organization._id,
    onChange: handleOrganization
  }, data.organizations.map(element => __jsx(MenuItem_default.a, {
    key: element._id,
    value: element._id,
    ola: element.name
  }, element.name)))) : __jsx(Input_default.a, {
  ...
  }), __jsx("br", null), __jsx(FormControl_default.a, {
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(InputLabel_default.a, null, "\u041F\u043E\u0434\u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F"), __jsx(Select_default.a, {
    value: subCategory._id,
    onChange: handleSubCategory
  }, data.subCategorys.map(element => __jsx(MenuItem_default.a, {
    key: element._id,
    value: element._id,
    ola: element.name
  }, element.name)))), __jsx("br", null), profile.role === 'admin' ? __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    className: classes.row
  }, __jsx(FormControlLabel_default.a, {
    control: __jsx(Switch_default.a, {
      checked: hit,
      onChange: () => {
        setHit(!hit);
      },
    ...
    label: "\u041D\u043E\u0432\u0438\u043D\u043A\u0430"
  })), __jsx("br", null)) : null, __jsx(TextField_default.a, {
    multiline: true,
    label: "\u0418\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F",
    value: info,
    className: isMobileApp ? classes.inputM : classes.inputD,
    ...
    className: classes.row
  }, router.query.id === 'new' ? __jsx(Button_default.a, {
    onClick: async () => {
    ...
    size: "small",
    color: "primary"
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C") : __jsx(external_react_default.a.Fragment, null, __jsx(Button_default.a, {
    onClick: async () => {
      let editElement = {
        _id: data.item._id
      };
      ...
      const action = async () => {
        await Object(items["i" /* setItem */])(editElement, subCategory._id); //Router.push(`/items/${subCategory._id}`)
      };
    ...
    onClick: async () => {
      const action = async () => {
        await Object(items["h" /* onoffItem */])([data.item._id]);
    ...
    size: "small",
    color: "primary"
  }, status === 'active' ? 'Отключить' : 'Включить'), profile.role === 'admin' ? __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
    ...
    size: "small",
    color: "primary"
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C") : null)))) : 'Ничего не найдено' : data.item === null || router.query.id === 'new' ? 'Ничего не найдено' : __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    ...
    className: classes.price
  }, data.item.price, "\xA0\u0441\u043E\u043C") : __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    className: classes.stockPrice
  }, data.item.stock, "\xA0\u0441\u043E\u043C"), __jsx("div", {
    className: classes.crossedPrice
  }, data.item.price, "\xA0\u0441\u043E\u043C"))), __jsx("br", null), profile.role === 'client' || !authenticated ? __jsx(external_react_default.a.Fragment, null, __jsx("div", {
  ...
  }, "\u0412 \u041A\u041E\u0420\u0417\u0418\u041D\u0423")), __jsx("br", null), __jsx("br", null), __jsx("div", {
    className: classes.share
    ...
    size: 32,
    round: true
  })), "\xA0 \xA0", __jsx(external_react_share_["VKShareButton"], {
    url:  false ? undefined : ''
  }, __jsx(external_react_share_["VKIcon"], {
    size: 32,
    round: true
  })), "\xA0 \xA0", __jsx(external_react_share_["OKShareButton"], {
    url:  false ? undefined : ''
  }, __jsx(external_react_share_["OKIcon"], {
    size: 32,
    round: true
  })), "\xA0 \xA0", __jsx(external_react_share_["WhatsappShareButton"], {
    url:  false ? undefined : ''
  }, __jsx(external_react_share_["WhatsappIcon"], {
    size: 32,
    round: true
  })), "\xA0 \xA0", __jsx(external_react_share_["TelegramShareButton"], {
    url:  false ? undefined : ''
...
Item.getInitialProps = async function (ctx) {
  return {
    data: Object(objectSpread["a" /* default */])({}, ctx.query.id !== 'new' ? await Object(items["f" /* getItem */])({
      _id: ctx.query.id
    }) : {
      item: {
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Item));
