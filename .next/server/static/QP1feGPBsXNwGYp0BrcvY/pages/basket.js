...
/******/ 			var chunk = require("../../../" + ({}[chunkId]||chunkId) + "." + {"0":"52b67b8692f90c0bbc2a","1":"16150a9b969281c52d64","24":"1efb470e322ec43e7a58"}[chunkId] + ".js");
...
const BuyBasket = dynamic_default()(() => __webpack_require__.e(/* import() */ 24).then(__webpack_require__.bind(null, "6gDJ")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("6gDJ")],
...
const Basket = external_react_default.a.memo(props => {
  ...
  let removeBasketChange = async idx => {
    const action = async () => {
      if (authenticated) {
        Object(gql_basket["b" /* deleteBasket */])([list[idx]._id]);
  ...
  return __jsx(App["a" /* default */], {
    getList: getList,
    pageName: "\u041A\u043E\u0440\u0437\u0438\u043D\u0430"
  }, __jsx(head_default.a, null, __jsx("title", null, "\u041A\u043E\u0440\u0437\u0438\u043D\u0430")), isMobileApp ? __jsx("div", {
    className: classes.column,
    style: {
      width: 'calc(100% - 16px)',
      margin: 8
    }
  }, list.map((row, idx) => __jsx(Card_default.a, {
  ...
  })) : __jsx(external_react_default.a.Fragment, null, __jsx(Card_default.a, {
    className: classes.page
  }, __jsx(CardActions_default.a, {
    className: classes.column,
    style: isMobileApp ? {} : {
  ...
  }, __jsx(TableHead_default.a, null, __jsx(TableRow_default.a, null, __jsx(TableCell_default.a, null), __jsx(TableCell_default.a, {
    align: "left"
  }, "\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E"), __jsx(TableCell_default.a, {
    align: "left"
  }, "\u0426\u0435\u043D\u0430"), __jsx(TableCell_default.a, {
    align: "left"
  }, "\u0418\u0442\u043E\u0433\u043E"), __jsx(TableCell_default.a, {
    align: "center"
  }, "\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C"))), __jsx(TableBody_default.a, null, list.map((row, idx) => __jsx(TableRow_default.a, {
    key: idx
  ...
  }, row.item.name))), __jsx(TableCell_default.a, {
    align: "left"
  }, __jsx("div", {
    ...
    align: "left"
  }, `${row.item.stock === 0 || row.item.stock === undefined ? row.item.price : row.item.stock * row.count} сом`), __jsx(TableCell_default.a, {
    align: "left"
  }, `${(row.item.stock === 0 || row.item.stock === undefined ? row.item.price : row.item.stock * row.count) * row.count} сом`), __jsx(TableCell_default.a, {
    align: "center"
  }, __jsx(IconButton_default.a, {
    onClick: () => {
      removeBasketChange(idx);
  ...
  }, __jsx(Cancel_default.a, null))))))))), __jsx("div", {
    style: {
      height: 70
    }
  })), __jsx("div", {
...
Basket.getInitialProps = async function (ctx) {
  return {
    data: Object(objectSpread["a" /* default */])({}, (await Object(gql_basket["c" /* getBasket */])()), ctx.store.getState().user.profile._id ? await Object(client["a" /* getClient */])({
...
/* harmony default export */ var pages_basket = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Basket));
