...
// CONCATENATED MODULE: ./src/styleMUI/organization/orgaizationsList.js

/* harmony default export */ var orgaizationsList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// CONCATENATED MODULE: ./src/styleMUI/organization/cardOrganization.js

/* harmony default export */ var cardOrganization = (Object(styles_["makeStyles"])({
  cardM: {
...
const CardOrganization = external_react_default.a.memo(props => {
  const classes = cardOrganization();
  const {
    element,
    setList
  } = props;
...
const Organization = external_react_default.a.memo(props => {
  const classes = orgaizationsList();
  const {
    data
  } = props;
  let {
  ...
  }, organizations_jsx(head_default.a, null, organizations_jsx("title", null, "\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438")), organizations_jsx("div", {
    className: classes.page
  }, list ? list.map(element => organizations_jsx(organization_CardOrganization, {
    key: element._id,
    setList: setList,
    element: element
