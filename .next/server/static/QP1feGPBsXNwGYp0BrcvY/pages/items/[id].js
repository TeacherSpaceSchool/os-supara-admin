...
// CONCATENATED MODULE: ./src/styleMUI/item/itemList.js

/* harmony default export */ var itemList = (Object(styles_["makeStyles"])({
  page: {
    paddingTop: 20,
    display: 'flex',
    alignItems: 'center',
...
// EXTERNAL MODULE: ./components/items/CardItem.js + 1 modules
...
// CONCATENATED MODULE: ./pages/items/[id].js
...
const Items = external_react_default.a.memo(props => {
  ...
  let {
    0: list,
    1: setList
  } = Object(external_react_["useState"])(data.items);
  const {
    search,
    filter,
    sort
  ...
  Object(external_react_["useEffect"])(() => {
    (async () => {
      setList((await Object(items["g" /* getItems */])({
  ...
  }, __jsx(head_default.a, null, __jsx("title", null, router.query.id === 'all' ? 'Все' : data.subCategory !== null ? data.subCategory.name : 'Ничего не найдено')), __jsx("div", {
    className: classes.page
  }, list ? list.map(element => __jsx(CardItem["a" /* default */], {
    setList: setList,
    key: element._id,
    element: element,
    subCategory: router.query.id === 'all' ? 'all' : data.subCategory._id
  })) : null), profile.role === 'admin' || profile.role === 'организация' || profile.role === 'менеджер' ? __jsx(link_default.a, {
    href: "/item/[id]",
    as: `/item/new`
  }, __jsx(Fab_default.a, {
    color: "primary",
  ...
  }, __jsx(Add_default.a, null))) : null);
});

Items.getInitialProps = async function (ctx) {
  return {
    data: await Object(items["g" /* getItems */])({
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps)(Items));
...
// CONCATENATED MODULE: ./src/styleMUI/item/cardItem.js

/* harmony default export */ var cardItem = (Object(styles_["makeStyles"])({
  card: {
    width: 280,
    margin: 10
  },
...
// EXTERNAL MODULE: external "@material-ui/icons/AddShoppingCart"
var AddShoppingCart_ = __webpack_require__("Xf5c");
...
// CONCATENATED MODULE: ./components/items/CardItem.js
...
const CardItem = external_react_default.a.memo(props => {
  ...
  let {
    0: favorite,
    1: setFavorite
  } = Object(external_react_["useState"])(element !== undefined && element.favorite !== undefined ? element.favorite : []);
  const {
    setMiniDialog,
    showMiniDialog
  ...
  Object(external_react_["useEffect"])(() => {
    if (!authenticated) {
      if (localStorage.favorites == undefined) localStorage.favorites = stringify_default()([]);else {
      ...
      if (localStorage.basket == undefined) localStorage.basket = stringify_default()([]);else {
        let basket = JSON.parse(localStorage.basket);

        for (let i = 0; i < basket.length; i++) {
          if (basket[i]._id == element._id) setBasket(true);
        }
      }
    } else {
  ...
  return __jsx(Card_default.a, {
  ...
  }, element.name)), __jsx(link_default.a, {
    href: "/item/[id]",
    as: `/item/${element !== undefined ? element._id : 'new'}`
  }, __jsx("div", {
  ...
  }, `${element.price} сом`) : __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    className: classes.crossedPrice
  }, `${element.price}`), __jsx("div", {
    className: classes.stockPrice
  }, `${element.stock} сом`)))), ['admin', 'организация', 'менеджер'].includes(profile.role) ? __jsx(external_react_default.a.Fragment, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(items["h" /* onoffItem */])([element._id]);
    ...
    size: "small",
    color: "primary"
  }, status === 'active' ? 'Отключить' : 'Включить'), 'admin' === profile.role ? __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
        const list = (await Object(items["c" /* deleteItem */])([element._id], subCategory)).items;
        setList(list);
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C") : null) : profile.role === 'client' || !authenticated ? __jsx(AddShoppingCart_default.a, {
    style: {
  ...
  }) : null, profile.role === 'client' || !authenticated ? __jsx(Star_default.a, {
    className: classes.buttonToggle,
    onClick: async () => {
      let index;

      if (profile.role === 'client') {
        await Object(items["d" /* favoriteItem */])([element._id]);
...
/* harmony default export */ var items_CardItem = __webpack_exports__["a"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardItem));
