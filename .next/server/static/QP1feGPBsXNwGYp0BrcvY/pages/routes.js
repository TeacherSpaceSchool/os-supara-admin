...
const CardOrder = external_react_default.a.memo(props => {
  ...
  return __jsx(Card_default.a, {
    ...
    className: classes.value
  }, external_moment_default()(element.dateStart).format('DD.MM.YY'))), __jsx("div", {
    className: classes.row
  }, __jsx("div", {
    className: classes.nameField
    ...
    key: idx,
    className: classes.value
  }, invoice.number))))))), __jsx(CardActions_default.a, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
...
const Routes = external_react_default.a.memo(props => {
  ...
  }, routes_jsx(head_default.a, null, routes_jsx("title", null, "\u041C\u0430\u0440\u0448\u0440\u0443\u0442\u043D\u044B\u0435 \u043B\u0438\u0441\u0442\u044B")), routes_jsx("div", {
    className: classes.page
  }, list ? list.map(element => routes_jsx(CardRoute, {
    setList: setList,
    key: element._id,
    element: element
