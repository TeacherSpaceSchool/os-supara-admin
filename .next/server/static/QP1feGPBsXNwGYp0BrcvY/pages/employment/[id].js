...
const Client = external_react_default.a.memo(props => {
  ...
  let {
    0: phone,
    1: setPhone
  } = Object(external_react_["useState"])(data.employment !== null ? data.employment.user.phone : '');
  let {
    0: organization,
    1: setOrganization
  ...
  }, __jsx(head_default.a, null, __jsx("title", null, data.employment !== null ? router.query.id === 'new' ? 'Добавить' : data.employment.name : 'Ничего не найдено')), __jsx(Card_default.a, {
