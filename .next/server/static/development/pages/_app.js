...
/* harmony import */ var _src_singleton_client__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../src/singleton/client */ "./src/singleton/client.js");
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_6___default()(_redux_configureStore__WEBPACK_IMPORTED_MODULE_7__["default"], {
  debug: false
  ...
  static async getInitialProps({
    ...
    new _src_singleton_client__WEBPACK_IMPORTED_MODULE_9__["SingletonApolloClient"](ctx.req);

    if (ctx.req) {
      ctx.store.getState().app.isMobileApp = Object(_src_lib__WEBPACK_IMPORTED_MODULE_12__["checkMobile"])(ctx.req.headers['user-agent']);
      ctx.store.getState().user.authenticated = Object(_src_lib__WEBPACK_IMPORTED_MODULE_12__["checkAuth"])(ctx.req.headers.cookie);
      if (ctx.store.getState().user.authenticated) ctx.store.getState().user.profile = await Object(_redux_actions_user__WEBPACK_IMPORTED_MODULE_11__["getProfile"])();
    }
  ...
  render() {
    ...
    new _src_singleton_store__WEBPACK_IMPORTED_MODULE_10__["SingletonStore"](store);
    return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_material_ui_styles__WEBPACK_IMPORTED_MODULE_3__["ThemeProvider"], {
