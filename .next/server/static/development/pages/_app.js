  ...
  static async getInitialProps({
    ...
    if (ctx.req) {
      ...
      if (ctx.store.getState().user.authenticated) {
        ctx.store.getState().user.profile = await Object(_redux_actions_user__WEBPACK_IMPORTED_MODULE_12__["getProfile"])((await Object(_src_getClientGQL__WEBPACK_IMPORTED_MODULE_14__["getClientGqlSsr"])(ctx.req)));
      }
    }
  ...
  const authLink = Object(apollo_link_context__WEBPACK_IMPORTED_MODULE_6__["setContext"])((_, {
    ...
    return {
      headers: Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, headers, {
        authorization: Object(_lib__WEBPACK_IMPORTED_MODULE_5__["getJWT"])(req.headers.cookie) ? `Bearer ${Object(_lib__WEBPACK_IMPORTED_MODULE_5__["getJWT"])(req.headers.cookie)}` : ''
      })
    };
  });
