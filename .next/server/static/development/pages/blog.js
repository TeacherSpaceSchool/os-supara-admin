...
/* harmony import */ var _src_styleMUI_blog_cardBlog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../src/styleMUI/blog/cardBlog */ "./src/styleMUI/blog/cardBlog.js");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-redux */ "react-redux");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _src_lib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../src/lib */ "./src/lib.js");
...
/* harmony import */ var _src_gql_blog__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../src/gql/blog */ "./src/gql/blog.js");
...
const CardBlog = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(props => {
  const classes = Object(_src_styleMUI_blog_cardBlog__WEBPACK_IMPORTED_MODULE_5__["default"])();
  const {
    element,
    setList
  } = props;
  ...
  let {
    0: text,
    1: setText
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(element ? element.text : '');

  let handleText = event => {
    setText(event.target.value);
  };

  let date = Object(_src_lib__WEBPACK_IMPORTED_MODULE_7__["pdDDMMYYYY"])(element ? new Date(element.updatedAt) : new Date());
  const {
    setMiniDialog,
    showMiniDialog
  } = props.mini_dialogActions;
  ...
  return __jsx(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_1___default.a, {
    ...
    __self: undefined
  }, profile.role === 'admin' ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_material_ui_core_CardHeader__WEBPACK_IMPORTED_MODULE_4___default.a, {
    subheader: date,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47
    ...
    __self: undefined
  }))), __jsx(_material_ui_core_CardActions__WEBPACK_IMPORTED_MODULE_9___default.a, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 81
    },
    __self: undefined
  }, element !== undefined ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_8___default.a, {
    onClick: async () => {
      let editElement = {
        _id: element._id
      };
      ...
      const action = async () => {
        setList((await Object(_src_gql_blog__WEBPACK_IMPORTED_MODULE_10__["setBlog"])(editElement)).blogs);
      };
    ...
    onClick: async () => {
      const action = async () => {
        setList((await Object(_src_gql_blog__WEBPACK_IMPORTED_MODULE_10__["deleteBlog"])([element._id])).blogs);
      };
    ...
    __self: undefined
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C")) : __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_8___default.a, {
    onClick: async () => {
      if (image !== undefined && text.length > 0 && title.length > 0) {
        ...
        const action = async () => {
          setList((await Object(_src_gql_blog__WEBPACK_IMPORTED_MODULE_10__["addBlog"])({
            image: image,
            text: text,
            title: title
          })).blogs);
    ...
    __self: undefined
  })) : element !== undefined ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_material_ui_core_CardActionArea__WEBPACK_IMPORTED_MODULE_2___default.a, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 140
    },
    ...
    __self: undefined
  }, element.text) : null, __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_8___default.a, {
    onClick: async () => {
      setAll(!all);
    },
    size: "small",
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_6__["connect"])(mapStateToProps, mapDispatchToProps)(CardBlog));
...
/* harmony import */ var _src_styleMUI_blog_blogList__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../src/styleMUI/blog/blogList */ "./src/styleMUI/blog/blogList.js");
/* harmony import */ var _src_gql_blog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../src/gql/blog */ "./src/gql/blog.js");
/* harmony import */ var _components_blog_CardBlog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/blog/CardBlog */ "./components/blog/CardBlog.js");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-redux */ "react-redux");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _redux_constants_other__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../redux/constants/other */ "./redux/constants/other.js");
...
const Blog = react__WEBPACK_IMPORTED_MODULE_1___default.a.memo(props => {
  const classes = Object(_src_styleMUI_blog_blogList__WEBPACK_IMPORTED_MODULE_3__["default"])();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.blogs);
  const {
    search,
    filter,
    sort
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    (async () => {
      setList((await Object(_src_gql_blog__WEBPACK_IMPORTED_MODULE_4__["getBlogs"])({
        search: search,
        sort: sort,
        filter: filter
      })).blogs);
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    property: "og:url",
    content: `${_redux_constants_other__WEBPACK_IMPORTED_MODULE_7__["urlMain"]}/blog`,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 32
    },
    ...
    rel: "canonical",
    href: `${_redux_constants_other__WEBPACK_IMPORTED_MODULE_7__["urlMain"]}/blog`,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33
    },
    ...
    __self: undefined
  }, profile.role === 'admin' ? __jsx(_components_blog_CardBlog__WEBPACK_IMPORTED_MODULE_5__["default"], {
    setList: setList,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 36
    ...
    __self: undefined
  }) : null, list ? list.map(element => __jsx(_components_blog_CardBlog__WEBPACK_IMPORTED_MODULE_5__["default"], {
    key: element._id,
    setList: setList,
    element: element,
    __source: {
...
Blog.getInitialProps = async function () {
  return {
    data: await Object(_src_gql_blog__WEBPACK_IMPORTED_MODULE_4__["getBlogs"])({
      search: '',
      sort: '-updatedAt',
      filter: ''
    })
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_6__["connect"])(mapStateToProps)(Blog));
...
/*!*************************!*\
  !*** ./src/gql/blog.js ***!
  \*************************/
/*! exports provided: getBlogs, deleteBlog, addBlog, setBlog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addBlog", function() { return addBlog; });
...
const deleteBlog = async ids => {
  try {
    ...
    return await getBlogs(new _singleton_store__WEBPACK_IMPORTED_MODULE_2__["SingletonStore"]().getStore().getState().app);
  } catch (err) {
    console.error(err);
  }
};
const addBlog = async element => {
  try {
    const client = new _singleton_client__WEBPACK_IMPORTED_MODULE_1__["SingletonApolloClient"]().getClient();
    await client.mutate({
      variables: element,
    ...
    let list = await getBlogs(new _singleton_store__WEBPACK_IMPORTED_MODULE_2__["SingletonStore"]().getStore().getState().app);
    return list;
  } catch (err) {
    console.error(err);
  }
};
const setBlog = async element => {
  try {
    const client = new _singleton_client__WEBPACK_IMPORTED_MODULE_1__["SingletonApolloClient"]().getClient();
    await client.mutate({
      variables: element,
...
module.exports = __webpack_require__(/*! C:\projects\azyk\azyk-admin\pages\blog.js */"./pages/blog.js");
