...
const CardItem = react__WEBPACK_IMPORTED_MODULE_1___default.a.memo(props => {
  ...
  return __jsx(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_2___default.a, {
    ...
    __self: undefined
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C") : null) : ['агент', 'client'].includes(profile.role) || !authenticated ? __jsx(_material_ui_icons_AddShoppingCart__WEBPACK_IMPORTED_MODULE_9___default.a, {
    style: {
      color: basket ? '#ffb300' : '#e1e1e1'
    },
    className: classes.button,
    onClick: () => {
      if (['агент', 'client'].includes(profile.role)) Object(_src_gql_basket__WEBPACK_IMPORTED_MODULE_13__["addBasket"])({
        item: element._id,
        count: 1
      ...
      setBasket(true);
      Object(_src_gql_basket__WEBPACK_IMPORTED_MODULE_13__["getCountBasket"])();
    },
    __source: {
      fileName: _jsxFileName,
      lineNumber: 131
...
/***/ "./components/items/CardItemPlaceholder.js":
/*!*************************************************!*\
  !*** ./components/items/CardItemPlaceholder.js ***!
  \*************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_styleMUI_item_cardItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../src/styleMUI/item/cardItem */ "./src/styleMUI/item/cardItem.js");
...
var _jsxFileName = "C:\\projects\\azyk\\azyk-admin\\components\\items\\CardItemPlaceholder.js";
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;



const CardOrderPlaceholder = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(() => {
  const classes = Object(_src_styleMUI_item_cardItem__WEBPACK_IMPORTED_MODULE_1__["default"])();
  return __jsx("div", {
    className: classes.card,
    style: {
      height: 377
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-redux */ "react-redux");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _src_styleMUI_favorite_favoriteList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../src/styleMUI/favorite/favoriteList */ "./src/styleMUI/favorite/favoriteList.js");
/* harmony import */ var _components_items_CardItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/items/CardItem */ "./components/items/CardItem.js");
...
/* harmony import */ var _components_items_CardItemPlaceholder__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/items/CardItemPlaceholder */ "./components/items/CardItemPlaceholder.js");

var _jsxFileName = "C:\\projects\\azyk\\azyk-admin\\pages\\favorite.js";
...
const Items = react__WEBPACK_IMPORTED_MODULE_2___default.a.memo(props => {
  const {
    authenticated
  } = props.user;
  const classes = Object(_src_styleMUI_favorite_favoriteList__WEBPACK_IMPORTED_MODULE_5__["default"])();
  const {
    data
  } = props;
  let {
    0: list,
    1: setList
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.favorites);
  const {
    search
  } = props.app;
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(() => {
    (async () => {
      ...
      } else setList((await Object(_src_gql_items__WEBPACK_IMPORTED_MODULE_7__["favorites"])({
        search: search
      })).favorites);
    })();
  }, [search]);
  ...
  let getList = async () => {
    setList((await Object(_src_gql_items__WEBPACK_IMPORTED_MODULE_7__["favorites"])({
      search: search
    })).favorites);
  };
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    property: "og:url",
    content: `${_redux_constants_other__WEBPACK_IMPORTED_MODULE_9__["urlMain"]}/favorite`,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51
    },
    ...
    rel: "canonical",
    href: `${_redux_constants_other__WEBPACK_IMPORTED_MODULE_9__["urlMain"]}/favorite`,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 52
    },
    ...
    __self: undefined
  }, list ? list.map(element => __jsx(react_lazyload__WEBPACK_IMPORTED_MODULE_10___default.a, {
    scrollContainer: '.App-body',
    key: element._id,
    height: height,
    offset: [height, 0],
    debounce: 50,
    placeholder: __jsx(_components_items_CardItemPlaceholder__WEBPACK_IMPORTED_MODULE_11__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 56
      },
    ...
    __self: undefined
  }, __jsx(_components_items_CardItem__WEBPACK_IMPORTED_MODULE_6__["default"], {
    setList: setList,
...
Items.getInitialProps = async function (ctx) {
  if ('client' !== ctx.store.getState().user.profile.role && ctx.store.getState().user.authenticated) if (ctx.res) {
    ...
    ctx.res.end();
  } else next_router__WEBPACK_IMPORTED_MODULE_8___default.a.push('/');
  return {
    data: await Object(_src_gql_items__WEBPACK_IMPORTED_MODULE_7__["favorites"])({
      search: ''
    })
  };
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_4__["connect"])(mapStateToProps)(Items));
...
/***/ "./src/styleMUI/favorite/favoriteList.js":
/*!***********************************************!*\
  !*** ./src/styleMUI/favorite/favoriteList.js ***!
  \***********************************************/
/*! exports provided: default */
...
module.exports = __webpack_require__(/*! C:\projects\azyk\azyk-admin\pages\favorite.js */"./pages/favorite.js");
