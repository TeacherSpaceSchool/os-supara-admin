...
/******/ 	var installedChunks = {
/******/ 		"static\\development\\pages\\organizations.js": 0
/******/ 	};
/******/
...
/* harmony import */ var _src_gql_organization__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../src/gql/organization */ "./src/gql/organization.js");
/* harmony import */ var react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! react-lazy-load-image-component */ "react-lazy-load-image-component");
...
const Confirmation = next_dynamic__WEBPACK_IMPORTED_MODULE_8___default()(() => __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ../../components/dialog/Confirmation */ "./components/dialog/Confirmation.js")), {
  loadableGenerated: {
...
const CardOrganization = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(props => {
  ...
  return __jsx(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_1___default.a, {
    ...
    __self: undefined
  }, __jsx(react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_12__["LazyLoadImage"], {
    effect: "blur",
    ...
    onClick: async () => {
      const action = async () => {
        await Object(_src_gql_organization__WEBPACK_IMPORTED_MODULE_11__["onoffOrganization"])([element._id]);
    ...
    onClick: async () => {
      const action = async () => {
        const list = (await Object(_src_gql_organization__WEBPACK_IMPORTED_MODULE_11__["deleteOrganization"])([element._id])).organizations;
        setList(list);
      };
