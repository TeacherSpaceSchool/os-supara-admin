...
const Client = react__WEBPACK_IMPORTED_MODULE_2___default.a.memo(props => {
  ...
  let {
    0: status,
    1: setStatus
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.client !== null ? data.client.user.status : '');
  let {
    0: name,
    1: setName
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.client !== null ? data.client.name : '');
  let {
    0: email,
    1: setEmail
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.client !== null ? data.client.email : '');
  let {
    0: phone,
    1: setPhone
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.client !== null ? data.client.user.phone : ''); //привести к геолокации
  ...
  let {
    0: address,
    1: setAddress
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.client !== null ? data.client.address : []);
  let {
    0: newAddress,
    1: setNewAddress
  ...
  let {
    0: info,
    1: setInfo
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.client !== null ? data.client.info : '');
  let {
    0: preview,
    1: setPreview
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.client !== null ? data.client.image : '');
  let {
    0: image,
    1: setImage
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: undefined
  }, data.client !== null ? data.client.name : 'Ничего не найдено'), __jsx("meta", {
    name: "description",
    content: info,
    __source: {
      fileName: _jsxFileName,
    ...
    property: "og:title",
    content: data.client !== null ? data.client.name : 'Ничего не найдено',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 85
    },
    ...
    property: "og:url",
    content: `http://${"localhost"}/client/${router.query.id}`,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 89
    },
    ...
    rel: "canonical",
    href: `http://${"localhost"}/client/${router.query.id}`,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 90
    },
    ...
    __self: undefined
  }, data.client !== null ? profile.role === 'admin' || profile._id === data.client.user._id ? __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx("label", {
