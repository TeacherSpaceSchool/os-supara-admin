...
const Basket = react__WEBPACK_IMPORTED_MODULE_5___default.a.memo(props => {
  ...
  let removeBasketChange = async idx => {
    const action = async () => {
      if (authenticated) {
        Object(_src_gql_basket__WEBPACK_IMPORTED_MODULE_21__["deleteBasket"])([list[idx]._id]);
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    __self: undefined
  }, __jsx(_material_ui_core_CardActions__WEBPACK_IMPORTED_MODULE_10___default.a, {
    className: classes.column,
    style: isMobileApp ? {} : {
