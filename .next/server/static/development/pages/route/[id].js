...
const Order = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(props => {
  ...
  return __jsx("div", {
    ...
    disabled: !['client', 'admin'].includes(profile.role) || 'принят' !== element.orders[0].status || ['менеджер', 'организация', 'экспедитор'].includes(profile.role) && !element.client.user,
    control: __jsx(_material_ui_core_Checkbox__WEBPACK_IMPORTED_MODULE_16___default.a, {
    ...
    label: !element.cancelClient && !element.cancelForwarder ? 'Заказ отменен' : `Заказ отменен. Востановить заказ до ${element.cancelClient ? Object(_src_lib__WEBPACK_IMPORTED_MODULE_11__["pdDDMMYYHHMMCancel"])(new Date(element.cancelClient)) : Object(_src_lib__WEBPACK_IMPORTED_MODULE_11__["pdDDMMYYHHMMCancel"])(new Date(element.cancelForwarder))}`,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 272
    },
    ...
    __self: undefined
  }, profile.role === 'client' || ['менеджер', 'организация', 'агент', 'экспедитор'].includes(profile.role) || profile.role === 'admin' ? __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_9___default.a, {
    variant: "contained",
    color: "primary",
    onClick: () => {
      const action = async () => {
...
const Route = react__WEBPACK_IMPORTED_MODULE_2___default.a.memo(props => {
  ...
  let {
    0: status,
    1: setStatus
  } = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(data.route.status);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(() => {
    (async () => {
      if (data.route && ['организация', 'менеджер', 'admin'].includes(profile.role)) {
        setUnselectedInvoices((await Object(_src_gql_order__WEBPACK_IMPORTED_MODULE_6__["getOrdersForRouting"])()).invoicesForRouting);
      }
    })();
  }, []);
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(() => {
  ...
  let getInvoices = async () => {
    if (data.route) {
      ...
      if (data.route._id) {
        let route = (await Object(_src_gql_route__WEBPACK_IMPORTED_MODULE_7__["getRoute"])({
          _id: data.route._id
        })).route;
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: undefined
  }, status), __jsx(_material_ui_core_CardContent__WEBPACK_IMPORTED_MODULE_12___default.a, {
    className: classes.column,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 135
    ...
    __self: undefined
  }, data.route.number), (router.query.id === 'new' || status === 'создан') && profile.role === 'admin' ? __jsx(_material_ui_core_FormControl__WEBPACK_IMPORTED_MODULE_17___default.a, {
    ...
    __self: undefined
  }), (router.query.id === 'new' || status === 'создан') && ['admin', 'организация', 'менеджер'].includes(profile.role) ? __jsx(_material_ui_core_FormControl__WEBPACK_IMPORTED_MODULE_17___default.a, {
    className: isMobileApp ? classes.inputM : classes.inputDF,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 162
    ...
    return __jsx("div", {
      ...
      __self: undefined
    }, ['обработка', 'принят'].includes(element.orders[0].status) && profile.role !== 'экспедитор' ? __jsx(_material_ui_core_Checkbox__WEBPACK_IMPORTED_MODULE_13___default.a, {
    ...
    __self: undefined
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), ['организация', 'менеджер', 'admin'].includes(profile.role) && status === 'создан' ? __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_23___default.a, {
    onClick: async () => {
      const action = async () => {
