...
/******/ 			var chunk = require("../../../../" + ({}[chunkId]||chunkId) + "." + {"0":"52b67b8692f90c0bbc2a","1":"16150a9b969281c52d64","26":"b22da30023fc0daf85ef","27":"59fdedf53c2f2d6f78f1"}[chunkId] + ".js");
...
const Route = external_react_default.a.memo(props => {
  ...
  if (!['организация', 'менеджер', 'admin', 'экспедитор'].includes(profile.role)) router_default.a.push('/');
  ...
  let {
    0: dateStart,
    1: setDateStart
  } = Object(external_react_["useState"])(data.route !== null ? external_moment_default()(new Date(data.route.dateStart)).format('YYYY-MM-DD') : null);
  let {
    0: dateEnd,
    1: setDateEnd
  } = Object(external_react_["useState"])(data.route !== null ? data.route.dateEnd : null);
  let {
    0: employment,
    1: setEmployment
  ...
  let {
    0: organization,
    1: setOrganization
  } = Object(external_react_["useState"])(router.query.id === 'new' ? {} : data.route.employment.organization);
  ...
  let {
    0: invoices,
    1: setInvoices
  } = Object(external_react_["useState"])(data.route !== null ? data.route.invoices : []);
  let {
    0: cancelInvoices,
    1: setCancelInvoices
  ...
  return __jsx(App["a" /* default */], {
  ...
  }, __jsx(head_default.a, null, __jsx("title", null, data.route ? router.query.id === 'new' ? 'Добавить' : data.route.number : 'Ничего не найдено')), __jsx(Card_default.a, {
  ...
  }, data.route.status), __jsx(CardContent_default.a, {
    className: classes.column
  }, data.route ? __jsx(external_react_default.a.Fragment, null, router.query.id === 'new' ? null : __jsx("div", {
    className: classes.number
  }, data.route.number), (router.query.id === 'new' || data.route.status === 'создан') && profile.role === 'admin' ? __jsx(FormControl_default.a, {
    ...
    value: element._id,
    ola: element.name
  }, element.name)))) : __jsx(TextField_default.a, {
    label: "\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u044F",
  ...
  }), __jsx("br", null), router.query.id === 'new' || data.route.status === 'создан' ? __jsx(FormControl_default.a, {
    className: isMobileApp ? classes.inputM : classes.inputDF
  }, __jsx(InputLabel_default.a, null, "\u042D\u043A\u0441\u043F\u0435\u0434\u0438\u0442\u043E\u0440"), __jsx(Select_default.a, {
    value: employment._id,
    onChange: handleEmployment
  }, employments.map(element => __jsx(MenuItem_default.a, {
    key: element._id,
    value: element._id,
    ola: element.name
  }, element.name)))) : __jsx(TextField_default.a, {
  ...
  }), __jsx("br", null), __jsx(TextField_default.a, {
    className: isMobileApp ? classes.inputM : classes.inputDF,
    label: "\u0414\u0430\u0442\u0430",
    type: "date",
    InputLabelProps: {
    ...
    return __jsx("div", {
      key: idx,
      className: classes.row
    }, ['обработка', 'принят'].includes(element.orders[0].status) ? __jsx(Checkbox_default.a, {
    ...
    }) : null, __jsx(CardOrder["a" /* default */], {
    ...
    size: "small",
    color: "primary"
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), data.route.status === 'создан' ? __jsx(external_react_default.a.Fragment, null, __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
    ...
    size: "small",
    color: "primary"
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C")) : null))) : 'Ничего не найдено', __jsx("br", null))));
});
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Route));
...
// CONCATENATED MODULE: ./src/styleMUI/orders/cardOrder.js

/* harmony default export */ var cardOrder = (Object(styles_["makeStyles"])({
  card: {
    width: 330,
    margin: 10,
    position: 'relative'
...
const Order = dynamic_default()(() => __webpack_require__.e(/* import() */ 26).then(__webpack_require__.bind(null, "r0lg")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("r0lg")],
    modules: ['../dialog/Order']
  }
});
const CardOrder = external_react_default.a.memo(props => {
  const classes = cardOrder();
  const {
    element,
    setList,
    route,
  ...
  }, __jsx(CardActionArea_default.a, null, __jsx(CardContent_default.a, {
    className: classes.column
  }, __jsx("div", {
    className: classes.row
  }, __jsx("div", {
  ...
  }, external_moment_default()(element.updatedAt).format('DD.MM.YY HH:mm')), "\xA0\xA0", __jsx("div", {
    className: classes.status,
    style: {
...
/* harmony default export */ var order_CardOrder = __webpack_exports__["a"] = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(CardOrder));
