...
const CardOrganization = external_react_default.a.memo(props => {
  ...
  return __jsx(Card_default.a, {
    ...
    key: idx,
    className: classes.value
  }, addres)))))))), __jsx(CardActions_default.a, null, profile.role === 'admin' ? __jsx(Button_default.a, {
    onClick: async () => {
      const action = async () => {
...
const Client = external_react_default.a.memo(props => {
  ...
  return clients_jsx(App["a" /* default */], {
    ...
    pageName: "\u041A\u043B\u0438\u0435\u043D\u0442\u044B"
  }, clients_jsx(head_default.a, null, clients_jsx("title", null, "\u041A\u043B\u0438\u0435\u043D\u0442\u044B")), clients_jsx("div", {
    className: classes.page
  }, list ? list.map(element => clients_jsx(CardClient, {
    key: element._id,
    setList: setList,
    element: element
  })) : null));
