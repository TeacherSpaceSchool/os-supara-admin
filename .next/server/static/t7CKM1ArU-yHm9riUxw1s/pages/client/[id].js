...
/* harmony import */ var _layouts_App__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("aSjJ");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("h74D");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_redux__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _src_gql_client__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("i3N8");
/* harmony import */ var _src_styleMUI_organization_organization__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("9lr4");
...
/* harmony import */ var _material_ui_core_CardActions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("PxrZ");
...
/* harmony import */ var _material_ui_core_Input__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("tBFs");
...
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("rKB8");
...
/* harmony import */ var _redux_actions_mini_dialog__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("pngM");
/* harmony import */ var _redux_actions_user__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("j6IE");
/* harmony import */ var next_dynamic__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("/T1H");
...
/* harmony import */ var _material_ui_icons_Done__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("2UeD");
...
/* harmony import */ var _material_ui_icons_Delete__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("ng1p");
...
/* harmony import */ var _material_ui_core_InputAdornment__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("lj8g");
...
/* harmony import */ var _material_ui_icons_Visibility__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__("4jCe");
...
/* harmony import */ var _material_ui_icons_VisibilityOff__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__("gGTQ");
...
/* harmony import */ var _material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__("IbbU");
...
/* harmony import */ var _material_ui_core_InputLabel__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("zOcm");
...
/* harmony import */ var react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__("g8bt");
/* harmony import */ var react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_23__);
...
const Confirmation = next_dynamic__WEBPACK_IMPORTED_MODULE_13___default()(() => __webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, "y4xb")), {
  loadableGenerated: {
    webpack: () => [/*require.resolve*/("y4xb")],
    modules: ['../../components/dialog/Confirmation']
  }
});
const Client = react__WEBPACK_IMPORTED_MODULE_1___default.a.memo(props => {
  const classes = Object(_src_styleMUI_organization_organization__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])();
  const {
    data
  } = props;
  const {
  ...
  let {
    0: status,
    1: setStatus
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.client !== null ? data.client.user.status : '');
  let {
    0: name,
    1: setName
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.client !== null ? data.client.name : '');
  let {
    0: address,
    1: setAddress
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.client !== null ? data.client.address : []);
  let {
    0: email,
    1: setEmail
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.client !== null ? data.client.email : '');
  let {
    0: phone,
    1: setPhone
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.client !== null ? data.client.user.phone : '');
  let {
    0: newAddress,
    1: setNewAddress
  ...
  let {
    0: info,
    1: setInfo
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.client !== null ? data.client.info : '');
  let {
    0: preview,
    1: setPreview
  } = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(data.client !== null ? data.client.image : '');
  let {
    0: image,
    1: setImage
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
    filters: data.filterSubCategory,
    sorts: data.sortSubCategory,
    pageName: data.client !== null ? data.client.name : 'Ничего не найдено'
  }, __jsx(next_head__WEBPACK_IMPORTED_MODULE_0___default.a, null, __jsx("title", null, data.client !== null ? data.client.name : 'Ничего не найдено')), __jsx(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_6___default.a, {
  ...
  }, data.client !== null ? profile.role === 'admin' || profile._id === data.client.user._id ? __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("label", {
    htmlFor: "contained-button-file"
  }, __jsx(react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_23__["LazyLoadImage"], {
    effect: "blur",
    className: classes.media,
    src: preview,
    alt: 'Добавить'
  })), __jsx("div", null, __jsx(_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_20___default.a, {
    label: "\u0418\u043C\u044F",
    value: name,
  ...
  }), __jsx(_material_ui_core_Input__WEBPACK_IMPORTED_MODULE_8___default.a, {
    ...
    endAdornment: __jsx(_material_ui_core_InputAdornment__WEBPACK_IMPORTED_MODULE_17___default.a, {
      ...
      onClick: handleHide
    }, hide ? __jsx(_material_ui_icons_VisibilityOff__WEBPACK_IMPORTED_MODULE_19___default.a, null) : __jsx(_material_ui_icons_Visibility__WEBPACK_IMPORTED_MODULE_18___default.a, null)))
  }), __jsx(_material_ui_core_FormControl__WEBPACK_IMPORTED_MODULE_21___default.a, {
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(_material_ui_core_InputLabel__WEBPACK_IMPORTED_MODULE_22___default.a, null, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0430\u0434\u0440\u0435\u0441"), __jsx(_material_ui_core_Input__WEBPACK_IMPORTED_MODULE_8___default.a, {
    value: newAddress,
    onChange: event => {
    ...
    endAdornment: __jsx(_material_ui_core_InputAdornment__WEBPACK_IMPORTED_MODULE_17___default.a, {
      ...
      "aria-label": "toggle password visibility"
    }, __jsx(_material_ui_icons_Done__WEBPACK_IMPORTED_MODULE_14___default.a, null)))
  })), address ? address.map((element, idx) => __jsx(_material_ui_core_FormControl__WEBPACK_IMPORTED_MODULE_21___default.a, {
    key: idx,
    className: isMobileApp ? classes.inputM : classes.inputD
  }, __jsx(_material_ui_core_InputLabel__WEBPACK_IMPORTED_MODULE_22___default.a, null, "\u0410\u0434\u0440\u0435\u0441"), __jsx(_material_ui_core_Input__WEBPACK_IMPORTED_MODULE_8___default.a, {
    placeholder: "\u0410\u0434\u0440\u0435\u0441",
    value: element,
    className: isMobileApp ? classes.inputM : classes.inputD,
    onChange: event => {
    ...
    endAdornment: __jsx(_material_ui_core_InputAdornment__WEBPACK_IMPORTED_MODULE_17___default.a, {
      ...
      "aria-label": "toggle password visibility"
    }, __jsx(_material_ui_icons_Delete__WEBPACK_IMPORTED_MODULE_15___default.a, null)))
  }))) : null, __jsx(_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_20___default.a, {
    label: "email",
    value: email,
    className: isMobileApp ? classes.inputM : classes.inputD,
    onChange: event => {
    ...
    onClick: async () => {
      ...
      const action = async () => {
        ...
        await Object(_src_gql_client__WEBPACK_IMPORTED_MODULE_4__[/* setClient */ "d"])(editElement);
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), profile.role === 'admin' ? __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_9___default.a, {
    onClick: async () => {
      const action = async () => {
        await Object(_src_gql_client__WEBPACK_IMPORTED_MODULE_4__[/* onoffClient */ "c"])([data.client._id]);
    ...
    size: "small",
    color: "primary"
  }, status === 'active' ? 'Отключить' : 'Включить') : __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_9___default.a, {
    onClick: () => {
      const action = async () => {
        logout();
      };
    ...
    size: "small",
    color: "primary"
  }, "\u0412\u044B\u0439\u0442\u0438")))) : __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_23__["LazyLoadImage"], {
    effect: "blur",
    className: classes.media,
    src: preview,
    alt: name
...
Client.getInitialProps = async function (ctx) {
  return {
    data: await Object(_src_gql_client__WEBPACK_IMPORTED_MODULE_4__[/* getClient */ "a"])({
      _id: ctx.query.id
    })
  };
};
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    userActions: Object(redux__WEBPACK_IMPORTED_MODULE_10__["bindActionCreators"])(_redux_actions_user__WEBPACK_IMPORTED_MODULE_12__, dispatch)
  };
}

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["connect"])(mapStateToProps, mapDispatchToProps)(Client));
