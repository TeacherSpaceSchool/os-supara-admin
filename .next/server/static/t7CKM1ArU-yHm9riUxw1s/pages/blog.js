...
const CardBlog = external_react_default.a.memo(props => {
  ...
  date = external_moment_default()(date).format('DD.MM.YYYY HH:mm');
  const {
    setMiniDialog,
    showMiniDialog
  ...
  })) : element !== undefined ? __jsx(external_react_default.a.Fragment, null, __jsx(CardActionArea_default.a, null, __jsx(external_react_lazy_load_image_component_["LazyLoadImage"], {
    effect: "blur",
    className: isMobileApp ? classes.mediaM : classes.mediaD,
    src: element.image,
    alt: element.title
...
const Blog = external_react_default.a.memo(props => {
  ...
  return blog_jsx(App["a" /* default */], {
    ...
    sorts: data.sortBlog,
    pageName: "\u0411\u043B\u043E\u0433"
  }, blog_jsx(head_default.a, null, blog_jsx("title", null, "\u0411\u043B\u043E\u0433")), blog_jsx("div", {
    className: classes.page
  }, profile.role === 'admin' ? blog_jsx(blog_CardBlog, {
    setList: setList
  }) : null, list ? list.map(element => blog_jsx(blog_CardBlog, {
    key: element._id,
    setList: setList,
    element: element
  })) : null));
