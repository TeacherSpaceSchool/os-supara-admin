...
const CardCategory = external_react_default.a.memo(props => {
  ...
  }, profile.role === 'admin' && element._id !== 'all' ? __jsx(external_react_default.a.Fragment, null, __jsx(CardActionArea_default.a, null, __jsx(CardContent_default.a, null, __jsx(TextField_default.a, {
    label: "\u0418\u043C\u044F",
    value: name,
...
const Subcategory = external_react_default.a.memo(props => {
  ...
  }, _id_jsx(head_default.a, null, _id_jsx("title", null, router.query.id === 'all' ? 'Все' : data.category !== null ? data.category.name : 'Ничего не найдено')), _id_jsx("div", {
    className: classes.page
  }, profile.role === 'admin' && router.query.id !== 'all' && data.category !== null ? _id_jsx(SubCardCategory, {
    categorys: categorys,
    category: router.query.id,
    setList: setList
  }) : null, data.subCategorys.length > 0 || router.query.id === 'all' ? _id_jsx(external_react_default.a.Fragment, null, _id_jsx(SubCardCategory, {
    element: {
      _id: 'all',
      name: 'Все товары'
    }
  }), _id_jsx("br", null), _id_jsx("br", null), list ? list.map(element => _id_jsx(SubCardCategory, {
    category: router.query.id,
    categorys: categorys,
    key: element._id,
    setList: setList,
