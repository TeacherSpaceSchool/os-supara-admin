...
var Route = react__WEBPACK_IMPORTED_MODULE_5___default.a.memo(function (props) {
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    __self: this
  }), (router.query.id === 'new' || data.route.status === 'создан') && ['admin', 'организация', 'менеджер'].includes(profile.role) ? __jsx(_material_ui_core_FormControl__WEBPACK_IMPORTED_MODULE_20__["default"], {
    className: isMobileApp ? classes.inputM : classes.inputDF,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 159
...
//# sourceMappingURL=[id].js.ce0db354e420caf49e72.hot-update.js.map