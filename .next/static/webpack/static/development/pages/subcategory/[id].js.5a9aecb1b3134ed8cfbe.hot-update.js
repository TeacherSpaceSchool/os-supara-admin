...
var Subcategory = react__WEBPACK_IMPORTED_MODULE_3___default.a.memo(function (props) {
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    __self: this
  }, profile.role === 'admin' && router.query.id !== 'all' && data.category !== null ? __jsx(_components_subcategory_SubCardCategory__WEBPACK_IMPORTED_MODULE_9__["default"], {
    categorys: categorys,
    category: router.query.id,
    setList: setList,
    __source: {
    ...
    __self: this
  }), data.subCategorys.length > 0 || router.query.id === 'all' ? __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, list ? list.map(function (element) {
...
//# sourceMappingURL=[id].js.5a9aecb1b3134ed8cfbe.hot-update.js.map