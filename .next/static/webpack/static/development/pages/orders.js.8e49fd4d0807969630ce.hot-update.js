...
var Order = react__WEBPACK_IMPORTED_MODULE_3___default.a.memo(function (props) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, console.log(!['client', 'admin'].includes(profile.role) || 'принят' !== element.orders[0].status || !(['менеджер', 'организация', 'экспедитор'].includes(profile.role) && !element.client.user)), __jsx(_material_ui_core_FormControlLabel__WEBPACK_IMPORTED_MODULE_20__["default"], {
...
//# sourceMappingURL=orders.js.8e49fd4d0807969630ce.hot-update.js.map