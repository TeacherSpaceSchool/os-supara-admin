...
var Order = react__WEBPACK_IMPORTED_MODULE_3___default.a.memo(function (props) {
  ...
  return __jsx("div", {
    ...
    __self: this
  })), console.log(!['client', 'admin'].includes(profile.role), ['принят'] !== element.orders[0].status), __jsx("div", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 256
    },
    ...
    control: __jsx(_material_ui_core_Checkbox__WEBPACK_IMPORTED_MODULE_19__["default"], {
      checked: cancelClient !== undefined || cancelForwarder !== undefined ? cancelClient !== undefined ? cancelClient : cancelForwarder : 'client' === profile.role ? cancelClient : cancelForwarder,
      onChange: function onChange() {
        if ('client' === profile.role) setCancelClient(!cancelClient);else if ('admin' === profile.role) {
          if (cancelClient !== undefined) setCancelClient(!cancelClient);else setCancelForwarder(!cancelForwarder);
        } else setConfirmationForwarder(!cancelForwarder);
      },
      color: "secondary",
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=orders.js.e22cea929a5164b7e0b9.hot-update.js.map