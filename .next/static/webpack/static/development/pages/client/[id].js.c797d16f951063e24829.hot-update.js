...
/* harmony import */ var _src_gql_client__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../src/gql/client */ "./src/gql/client.js");
/* harmony import */ var _src_styleMUI_organization_organization__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../src/styleMUI/organization/organization */ "./src/styleMUI/organization/organization.js");
...
/* harmony import */ var _material_ui_icons_Done__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @material-ui/icons/Done */ "./node_modules/@material-ui/icons/Done.js");
/* harmony import */ var _material_ui_icons_Done__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_material_ui_icons_Done__WEBPACK_IMPORTED_MODULE_16__);
...
/* harmony import */ var react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! react-lazy-load-image-component */ "./node_modules/react-lazy-load-image-component/build/index.js");
/* harmony import */ var react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_25__);
...
var Client = react__WEBPACK_IMPORTED_MODULE_4___default.a.memo(function (props) {
  ...
  var classes = Object(_src_styleMUI_organization_organization__WEBPACK_IMPORTED_MODULE_8__["default"])();
  var data = props.data;
  var isMobileApp = props.app.isMobileApp;

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(data.client !== null ? data.client.user.status : ''),
      status = _useState[0],
      setStatus = _useState[1];

  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(data.client !== null ? data.client.name : ''),
      name = _useState2[0],
      setName = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(data.client !== null ? data.client.email : ''),
      email = _useState3[0],
      setEmail = _useState3[1];

  var _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(data.client !== null ? data.client.user.phone : ''),
      phone = _useState4[0],
      setPhone = _useState4[1];

  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(data.client !== null ? data.client.address : []),
  ...
  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(data.client !== null ? data.client.info : ''),
      info = _useState7[0],
      setInfo = _useState7[1];

  var _useState8 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(data.client !== null ? data.client.image : ''),
      preview = _useState8[0],
      setPreview = _useState8[1];

  var _useState9 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(undefined),
      image = _useState9[0],
  ...
  var _useState11 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])('password'),
      hide = _useState11[0],
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    __self: this
  }, data.client !== null ? data.client.name : 'Ничего не найдено')), __jsx(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    __self: this
  }, __jsx(_material_ui_core_CardActions__WEBPACK_IMPORTED_MODULE_10__["default"], {
    ...
    __self: this
  }, data.client !== null ? profile.role === 'admin' || profile._id === data.client.user._id ? __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx("label", {
    ...
    __self: this
  }, __jsx(react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_25__["LazyLoadImage"], {
    ...
    __self: this
  }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0430\u0434\u0440\u0435\u0441"), __jsx(_material_ui_core_Input__WEBPACK_IMPORTED_MODULE_11__["default"], {
    value: newAddress,
    onChange: function onChange(event) {
    ...
    endAdornment: __jsx(_material_ui_core_InputAdornment__WEBPACK_IMPORTED_MODULE_19__["default"], {
      ...
      __self: this
    }, __jsx(_material_ui_icons_Done__WEBPACK_IMPORTED_MODULE_16___default.a, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 130
      },
    ...
    return __jsx(_material_ui_core_FormControl__WEBPACK_IMPORTED_MODULE_23__["default"], {
      key: idx,
      className: isMobileApp ? classes.inputM : classes.inputD,
      __source: {
        fileName: _jsxFileName,
      ...
      __self: this
    }, "\u0410\u0434\u0440\u0435\u0441"), __jsx(_material_ui_core_Input__WEBPACK_IMPORTED_MODULE_11__["default"], {
      placeholder: "\u0410\u0434\u0440\u0435\u0441",
      value: element,
      className: isMobileApp ? classes.inputM : classes.inputD,
      onChange: function onChange(event) {
  ...
  }) : null, __jsx(_material_ui_core_TextField__WEBPACK_IMPORTED_MODULE_22__["default"], {
    label: "email",
    value: email,
    className: isMobileApp ? classes.inputM : classes.inputD,
    onChange: function onChange(event) {
                  ...
                  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return Object(_src_gql_client__WEBPACK_IMPORTED_MODULE_7__["setClient"])(editElement);
    ...
    __self: this
  }, "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C"), profile.role === 'admin' ? __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
    onClick:
    /*#__PURE__*/
    Object(_babel_runtime_corejs2_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(
    /*#__PURE__*/
                  ...
                  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          _context3.next = 2;
                          return Object(_src_gql_client__WEBPACK_IMPORTED_MODULE_7__["onoffClient"])([data.client._id]);
    ...
    __self: this
  }, "\u0412\u044B\u0439\u0442\u0438")))) : __jsx(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null, __jsx(react_lazy_load_image_component__WEBPACK_IMPORTED_MODULE_25__["LazyLoadImage"], {
    placeholderSrc: "/static/add.png",
    effect: "blur",
    className: classes.media,
    src: preview,
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 3;
            return Object(_src_gql_client__WEBPACK_IMPORTED_MODULE_7__["getClient"])({
              _id: ctx.query.id
            });
...
//# sourceMappingURL=[id].js.c797d16f951063e24829.hot-update.js.map