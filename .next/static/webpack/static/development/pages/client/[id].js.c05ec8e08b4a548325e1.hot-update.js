...
var Client = react__WEBPACK_IMPORTED_MODULE_5___default.a.memo(function (props) {
  ...
  var router = Object(next_router__WEBPACK_IMPORTED_MODULE_26__["useRouter"])();
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    property: "og:url",
    content: "http://".concat("localhost", "/client/").concat(router.query.id),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 89
    },
    ...
    rel: "canonical",
    href: "http://".concat("localhost", "/client/").concat(router.query.id),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 90
    },
...
//# sourceMappingURL=[id].js.c05ec8e08b4a548325e1.hot-update.js.map