...
var Client = react__WEBPACK_IMPORTED_MODULE_5___default.a.memo(function (props) {
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    __self: this
  })), type === 'торговая точка' ? __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_13__["default"], {
    size: "small",
    color: certificate ? 'primary' : 'secondary',
    ...
    __self: this
  }, certificate ? 'Изменить свидетельство' : 'Добавить свидетельство'), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_13__["default"], {
    size: "small",
    color: certificate ? 'primary' : 'secondary',
    onClick: function onClick() {
    ...
    __self: this
  }, passport ? 'Изменить паспорт' : 'Добавить паспорт'), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_13__["default"], {
    size: "small",
    color: certificate ? 'primary' : 'secondary',
    onClick: function onClick() {
    ...
    __self: this
  }, patent ? 'Изменить патент' : 'Добавить патент')) : null), __jsx("div", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 151
    },
...
//# sourceMappingURL=[id].js.967e2daf73cfb40a9cd9.hot-update.js.map