...
var Client = react__WEBPACK_IMPORTED_MODULE_5___default.a.memo(function (props) {
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    __self: this
  })), type === 'торговая точка' ? __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, __jsx("label", {
    htmlFor: "input-certificate",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 135
    },
    ...
    __self: this
  }, certificate ? 'Изменить свидетельство' : 'Добавить свидетельство')), __jsx("label", {
    ...
    __self: this
  }, passport ? 'Изменить паспорт' : 'Добавить паспорт')), __jsx("label", {
    htmlFor: "input-patent",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 145
    },
...
//# sourceMappingURL=[id].js.a0231c7d750a34dfb43a.hot-update.js.map