...
var Client = react__WEBPACK_IMPORTED_MODULE_5___default.a.memo(function (props) {
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    __self: this
  }, "\u0421\u043A\u0430\u0447\u0430\u0442\u044C")) : null, __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_13__["default"], {
    size: "small",
    ...
    __self: this
  }, certificate ? 'Изменить' : 'Добавить')), __jsx("div", {
    className: classes.row,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 158
    ...
    __self: this
  }, passport ? 'Изменить' : 'Добавить')), __jsx("div", {
    className: classes.row,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 175
    ...
    __self: this
  }, patent ? 'Изменить' : 'Добавить'))) : null), __jsx("div", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 197
    },
...
//# sourceMappingURL=[id].js.15698625226e7e09006f.hot-update.js.map