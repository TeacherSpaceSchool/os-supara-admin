...
var Order = react__WEBPACK_IMPORTED_MODULE_3___default.a.memo(function (props) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, profile.role === 'client' || ['менеджер', 'организация', 'агент'].includes(profile.role) || profile.role === 'admin' ? __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
    variant: "contained",
    color: "primary",
    onClick: function onClick() {
      var action =
...
//# sourceMappingURL=orders.js.8d7b12022becd8c8e1df.hot-update.js.map