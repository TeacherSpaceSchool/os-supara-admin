...
var Item = react__WEBPACK_IMPORTED_MODULE_7___default.a.memo(function (props) {
  ...
  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(data.item !== null ? data.item.subCategory : {}),
      subCategory = _useState5[0],
      setSubCategory = _useState5[1];

  var _useState6 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(data.item !== null ? data.item.status : ''),
      status = _useState6[0],
  ...
  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(data.item !== null ? data.item.organization : {}),
  ...
  var _useState8 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(data.item !== null ? data.item.hit : false),
      hit = _useState8[0],
      setHit = _useState8[1];

  var _useState9 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(data.item !== null ? data.item.latest : false),
      latest = _useState9[0],
      setLatest = _useState9[1];

  var _useState10 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(data.item !== null ? data.item.image : ''),
      preview = _useState10[0],
      setPreview = _useState10[1];

  var _useState11 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(undefined),
      image = _useState11[0],
  ...
  var _useState14 = Object(react__WEBPACK_IMPORTED_MODULE_7__["useState"])(data.item !== null && data.item.favorite !== undefined ? data.item.favorite : []),
  ...
  return __jsx(_layouts_App__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    __self: this
  }, profile.role === 'admin' || router.query.id === 'new' || ['менеджер', 'организация'].includes(profile.role) && data.item.organization._id === employment.organization._id ? data.item !== null || router.query.id === 'new' ? __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, __jsx("label", {
    ...
    __self: this
  }), __jsx(_material_ui_icons_Star__WEBPACK_IMPORTED_MODULE_32___default.a, {
    ...
    __self: this
  }), profile.role === 'client' || !authenticated ? __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, null, __jsx("div", {
    ...
    onClick: function onClick() {
      if (profile.role === 'client') Object(_src_gql_basket__WEBPACK_IMPORTED_MODULE_14__["addBasket"])({
        item: data.item._id,
...
//# sourceMappingURL=[id].js.0fb1033a6e52bac27168.hot-update.js.map