...
const Returned =  React.memo(
    (props) =>{
        ...
        const allowOrganization = (['менеджер', 'организация', 'агент'].includes(profile.role)&&((profile.organization===element.organization._id&&!element.distributer&&!element.distributer._id)||(element.distributer&&element.distributer._id&&profile.organization===element.distributer._id)))
